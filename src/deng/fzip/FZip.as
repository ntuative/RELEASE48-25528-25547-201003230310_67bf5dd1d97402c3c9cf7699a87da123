package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_454 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         return !true ? var_117[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_610))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_610,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_89 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_610,"EOF"));
            }
         }
      }
      ...
      {
         if(var_454.parse(param1))
         {
            var_44.push(var_454);
            if(false)
            {
               var_117["null"] = var_454;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1387,var_454));
            var_454 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_44 != null && var_117 != null && param1 < var_44.length)
         {
            _loc2_ = var_44[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_44.splice(param1,1);
               delete var_117[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
