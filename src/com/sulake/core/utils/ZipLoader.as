package com.sulake.core.utils
{
   ...
   public class ZipLoader extends LibraryLoader
   {
      ...
      private function onLoaderComplete(param1:Event) : void
      {
         ...
         var_1186.push(var_15.contentLoaderInfo.applicationDomain.getDefinition(_loc3_));
         ++var_797;
         if(var_1186.length == var_1815)
         {
         ...
         {
            var_15.loadBytes(var_392.getFileAt(var_797).content);
         }
      }
