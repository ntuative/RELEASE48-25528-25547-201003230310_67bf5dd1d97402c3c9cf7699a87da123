package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1280:Map = new Map();
      
      private static var var_854:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_854.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_854.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_854.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_854.remove(param1);
         var_854.add(param1,param2);
      }
