package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_940:uint = 256;
      
      protected static var var_632:uint = 0;
      
      protected static var var_373:uint = 0;
      
      public static const const_901:uint = 2;
      
      public static const const_1569:uint = 128;
      
      public static const const_1503:uint = 64;
      
      public static const const_634:uint = 4;
      
      public static const const_1321:uint = 0;
      
      public static const const_1275:uint = 16;
      
      public static const const_729:uint = 1;
      
      public static const const_1302:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_626:Boolean;
      
      protected var var_1601:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_901:
               ...
               break;
            case GraphicContext.const_1302:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1275:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_634:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_940:
               break;
            case GraphicContext.const_1321:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_626)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_373 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_626)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_373 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1601,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1601,16777215);
                  }
                  var_373 += bitmap.width * bitmap.height * 4;
               }
