package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_795:uint = 8;
       
      
      private var var_2230:Dictionary;
      
      private var var_1584:Dictionary;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_750:Dictionary;
      
      private var var_2229:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_750 = new Dictionary();
         var_751 = new Dictionary();
         var_1584 = new Dictionary();
         var_2229 = new Dictionary();
         TypeCodeTable.fillTables(var_1584,var_2229);
         var_1358 = new Dictionary();
         var_2230 = new Dictionary();
         StateCodeTable.fillTables(var_1358,var_2230);
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1584[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_750[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_750[param1] = new Array(SkinContainer.const_795);
         }
         var_750[param1][param2] = param3;
         if(true)
         {
            var_751[param1] = new Array(SkinContainer.const_795);
         }
