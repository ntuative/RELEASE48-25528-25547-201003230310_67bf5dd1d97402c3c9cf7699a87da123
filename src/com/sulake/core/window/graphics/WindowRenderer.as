package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1547:Rectangle;
      
      private var var_308:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_602 = new Array();
         var_1546 = new Point();
         var_1547 = new Rectangle();
         var_307 = new Rectangle();
         var_308 = new Dictionary(true);
         var_684 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_308[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_602.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_307.x = _loc3_.dirty.x;
               var_307.y = _loc3_.dirty.y;
               var_307.width = _loc3_.dirty.width;
               var_307.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_307);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_531,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_308[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_602 = null;
            for(_loc1_ in var_308)
            {
               delete var_308[_loc1_];
            }
            var_308 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1546,var_1547))
            {
               if(param2.render(param1,var_1546,var_1547))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_684);
            var_308[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_531,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_307.x = param2.x - param1.x;
            var_307.y = param2.y - param1.y;
            var_307.width = param2.width;
            var_307.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  var_307.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_307,WindowRedrawFlag.const_234);
            if(var_602.indexOf(param1) == -1)
            {
               var_602.push(param1);
            }
         }
