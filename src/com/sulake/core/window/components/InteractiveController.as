package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2256:uint = 0;
      
      protected var var_940:String = "";
      
      protected var var_445:Array;
      
      protected var var_941:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_445 = new Array();
         var_445[0] = MouseCursorType.const_294;
         var_445[1] = MouseCursorType.const_40;
         var_445[2] = MouseCursorType.const_294;
         var_445[3] = MouseCursorType.const_294;
         var_445[4] = MouseCursorType.const_40;
         var_445[5] = MouseCursorType.const_40;
         var_445[6] = MouseCursorType.const_294;
         if(var_327 == null)
         {
            var_327 = new Array();
            var_327[0] = WindowState.const_89;
            var_327[1] = WindowState.const_73;
            var_327[2] = WindowState.const_79;
            var_327[3] = WindowState.const_58;
            var_327[4] = WindowState.WINDOW_STATE_SELECTED;
            var_327[5] = WindowState.const_96;
            var_327[6] = WindowState.const_67;
         }
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_915,param1.toolTipDelay != const_1401));
         return param2;
      }
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               ...
               case "mouse_cursor_hovering":
                  param1.method_3(WindowState.const_79,_loc3_.value as uint);
                  break;
               case "mouse_cursor_pressed":
                  param1.method_3(WindowState.const_96,_loc3_.value as uint);
                  break;
               case "mouse_cursor_disabled":
                  param1.method_3(WindowState.const_67,_loc3_.value as uint);
                  break;
            }
         }
      }
      ...
      {
         var_940 = param1 == null ? const_743 : param1;
      }
      ...
      public function method_3(param1:uint, param2:uint) : void
      {
