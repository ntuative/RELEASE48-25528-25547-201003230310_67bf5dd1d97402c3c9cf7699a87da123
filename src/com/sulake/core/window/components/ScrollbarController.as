package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1055:String = "increment";
      
      private static const const_487:String = "slider_bar";
      
      private static const const_1054:String = "decrement";
      
      private static const const_749:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_161 = false;
         var_20 = param12;
         _horizontal = param2 == WindowType.const_460;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_487:
               if(param2.type == WindowNotifyEvent.const_265)
               {
                  if(!var_555)
                  {
                     if(_horizontal)
      ...
      {
         return findChildByName(ScrollbarController.const_749) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_20 != null && true)
         {
            IWindow(var_20).removeEventListener(WindowEvent.const_44,onScrollableResized);
         }
         var_20 = param1;
         if(var_20 != null && true)
         {
            IWindow(var_20).addEventListener(WindowEvent.const_44,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1055)
            {
               if(var_20)
               {
                  var_555 = true;
            ...
            else if(param2.name == ScrollbarController.const_1054)
            {
               if(var_20)
               {
                  var_555 = true;
            ...
            else if(param2.name == ScrollbarController.const_749)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_860)
         {
