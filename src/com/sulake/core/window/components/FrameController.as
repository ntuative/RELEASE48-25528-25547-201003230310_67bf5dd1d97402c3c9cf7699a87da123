package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_777:String = "margin_top";
      
      private static const const_1112:String = "_HEADER";
      
      private static const const_779:String = "margin_right";
      
      private static const const_1111:String = "_SCALER";
      
      private static const const_1109:String = "_TITLE";
      
      private static const const_1110:String = "_CONTENT";
      
      private static const const_780:String = "margin_left";
      
      private static const const_778:String = "margin_bottom";
      ...
      private var var_1292:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_780,_loc3_.left,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_777,_loc3_.top,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_779,0 - _loc3_.right,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_778,0 - _loc3_.bottom,PropertyStruct.const_62,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_237);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_227);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_222);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1292 == null)
         {
            var_1292 = findChildByTag(const_1112) as IHeaderWindow;
            if(!var_1292)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1109) as ITextWindow;
            if(!_title)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_249,false);
         }
      ...
      {
         return content != null && var_1373 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1110) as IWindowContainer;
            if(!var_19)
            {
