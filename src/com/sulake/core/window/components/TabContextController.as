package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1081:String = "content";
      ...
      protected var var_933:ITabSelectorWindow;
      
      private var var_867:Boolean = false;
      
      protected var var_1600:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1600 == null)
         {
            var_1600 = findChildByTag(TabContextController.const_1081) as IWindowContainer;
         }
         return var_1600;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_933 == null)
         {
            var_933 = findChildByTag(TabContextController.const_1082) as ITabSelectorWindow;
            if(var_933 != null)
            {
               var_933.procedure = selectorEventProc;
            }
         }
         return var_933;
      }
      ...
      {
         return !!var_867 ? selector.iterator : null;
      }
