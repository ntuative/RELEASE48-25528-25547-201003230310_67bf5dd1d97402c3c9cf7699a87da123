package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1033:String = "spacing";
      ...
      protected var var_535:Boolean = false;
      
      protected var var_2333:Number = 0;
      
      protected var var_536:Number;
      
      protected var var_1104:Boolean = false;
      
      protected var var_537:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_161 = var_631 || !testParamFlag(WindowParam.const_32);
         _container = var_14.create("_CONTAINER","",WindowType.const_336,WindowStyle.const_312,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_251,containerEventHandler);
         _container.addEventListener(WindowEvent.const_450,containerEventHandler);
         resizeOnItemUpdate = var_1104;
      }
      ...
      {
         return new Rectangle(var_536 * maxScrollH,var_537 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_251,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_536 = param1;
            _container.x = -var_536 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1033,_spacing,PropertyStruct.const_62,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1031,var_761,PropertyStruct.const_55,var_761 != const_1406));
         _loc1_.push(new PropertyStruct(const_1032,var_535,PropertyStruct.const_55,var_535 != const_1407));
         _loc1_.push(new PropertyStruct(const_1034,var_1104,PropertyStruct.const_55,var_1104 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_537 = param1;
            _container.y = -var_537 * maxScrollV;
            var_14.invalidate(_container,visibleRegion,WindowRedrawFlag.const_70);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1034:
                  ...
                  break;
               case const_1031:
                  var_761 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_475,param1);
            }
            else
            {
