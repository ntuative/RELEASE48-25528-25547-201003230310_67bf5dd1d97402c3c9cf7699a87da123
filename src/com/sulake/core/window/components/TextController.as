package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2335:Rectangle = new Rectangle();
       
      
      protected var var_207:Boolean;
      
      protected var var_65:TextMargins;
      
      protected var var_533:String = "none";
      ...
      protected var var_758:Boolean = false;
      ...
      {
         var_65 = new TextMargins(0,0,0,0,setTextMargins);
         var_207 = false;
         var_625 = 0;
         var_367 = 0;
         if(_field == null)
      ...
      {
         param1.var_65.dispose();
         param1.var_65 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_625 * maxScrollH,var_367 * maxScrollV,width,height);
      }
      ...
      {
         var_625 = param1;
         _field.scrollH = var_625 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_207)
         {
            if(param2.type == WindowNotifyEvent.const_172)
            {
               refreshTextImage();
            }
         }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_65.dispose();
            var_65 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_915,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_364,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_55,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_55,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_364,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_55,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_55,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_55,true));
         ...
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_55,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_55,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_595,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_595,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_55,true));
         _loc1_.push(new PropertyStruct("margin_left",var_65.left,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_top",var_65.top,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_right",var_65.right,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_65.bottom,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("auto_size",var_533,PropertyStruct.STRING,var_533 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_55,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_55,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_55,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_55,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_595,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_625 = var_625;
         _loc1_.var_367 = var_367;
         _loc1_.var_65 = var_65.clone(_loc1_.setTextMargins);
         _loc1_.var_533 = var_533;
         _loc1_.var_758 = var_758;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_533 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_533 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_533 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_533 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
