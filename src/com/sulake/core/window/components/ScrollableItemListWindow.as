package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_866:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_352)
         {
            var_352 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_352)
            {
               var_352.addEventListener(WindowEvent.const_236,scrollBarEventProc);
               var_352.addEventListener(WindowEvent.const_230,scrollBarEventProc);
            }
         }
         return var_352;
      }
      ...
      override public function dispose() : void
      {
         if(var_352)
         {
            var_352.removeEventListener(WindowEvent.const_236,scrollBarEventProc);
            var_352.removeEventListener(WindowEvent.const_230,scrollBarEventProc);
            var_352 = null;
         }
         if(var_866)
         {
      ...
      {
         if(param1.type == WindowEvent.const_236)
         {
            showScrollBar();
         }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_866)
         {
            var_866 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_866;
      }
