package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_427:int = 2147483647;
      ...
      {
         return var_425 == int.MIN_VALUE && var_427 == int.MAX_VALUE && var_426 == int.MIN_VALUE && var_428 == int.MAX_VALUE;
      }
      
      public function set maxWidth(param1:int) : void
      {
         var_427 = param1;
         if(var_427 < int.MAX_VALUE && true && _target.width > var_427)
         {
      ...
      {
         var_428 = param1;
         if(var_428 < int.MAX_VALUE && true && _target.height > var_428)
         {
            _target.height = var_428;
         }
      }
