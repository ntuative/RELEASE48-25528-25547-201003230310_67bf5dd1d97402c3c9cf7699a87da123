package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1613:String = "_INCLUDE";
      
      public static const const_884:String = "_EXCLUDE";
      
      public static const const_1622:String = "_TEMP";
      
      private static const const_1121:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1122:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1379:Map;
      
      protected var var_14:IWindowContext;
      
      protected var var_1378:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_939 = new Dictionary();
         var_1378 = new Dictionary();
         ParamCodeTable.fillTables(var_939,var_1378);
         var_1379 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1122,"");
         return param1.replace(const_1121,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_939)
            {
               delete var_939[_loc1_];
            }
            for(_loc1_ in var_1378)
            {
               delete var_1378[_loc1_];
            }
            var_1379.dispose();
            var_1379 = null;
            var_14 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = method_1(xml,"visible",variables,visible.toString()) == "true";
         ...
         background = method_1(xml,"background",variables,window.background.toString()) == "true";
         blend = Number(method_1(xml,"blend",variables,window.blend.toString()));
         clipping = method_1(xml,"clipping",variables,window.clipping.toString()) == "true";
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_154)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_884) == -1)
                  {
