package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1478:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_890:uint = 4;
      ...
      protected var var_2213:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_937 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_937);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1107 & const_890)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_419 + "]";
      }
   }
}
