package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1290:int = 10000;
      ...
      private var var_720:IEncryption;
      
      private var var_721:int;
      
      private var var_357:ByteArray;
      ...
      private var var_601:IProtocol;
      
      private var var_875:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_315 = param2;
         var_357 = new ByteArray();
         var_875 = new MessageClassManager();
         var_77 = new Socket();
         var_355 = new Timer(const_1290,1);
      ...
      {
         var_355.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_721));
      ...
      {
         var_355.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_721));
      ...
      private function onConnect(param1:Event) : void
      {
         var_355.stop();
         var_1297 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_721));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_875.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_601.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_356)
         {
         ...
         if(var_720 != null)
         {
            _loc3_ = var_720.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_357.writeByte(var_77.readUnsignedByte());
         }
      }
      ...
      {
         var_875.registerMessages(param1);
      }
      ...
      {
         var_355.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_721));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_601.getMessages(var_357,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            _loc7_ = var_875.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_357,_loc2_);
            var_357 = _loc18_;
         }
      }
      ...
      {
         var_355.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_721));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_355.stop();
         var_1297 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_721));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_720 + "\n");
      }
   }
}
