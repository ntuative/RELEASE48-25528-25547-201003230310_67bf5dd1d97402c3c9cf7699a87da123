package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1058:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_604:uint = 0;
      
      public static const const_987:String = "AssetLibraryReady";
      
      public static const const_1250:String = "AssetLibraryUnloaded";
      
      public static const const_371:String = "AssetLibraryLoaded";
      
      public static const const_1185:String = "AssetLibraryLoadError";
       
      
      private var var_503:XML;
      ...
      private var var_502:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_604;
         var_424 = new Dictionary(false);
         var_423 = new Dictionary(false);
         var_729 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_424)
         {
            _loc4_ = AssetTypeDeclaration(var_424[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_423)
         {
            _loc2_ = var_423[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_423[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_729)
         {
         ...
         var_314 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1250));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_503 = _loc2_.manifest.copy();
         var_358 = _loc2_.resource;
         if(var_502)
         {
            AssetLibrary.fetchLibraryContents(this,var_503,var_358);
         }
         var_314 = true;
         dispatchEvent(new Event(AssetLibrary.const_371));
         dispatchEvent(new Event(AssetLibrary.const_987));
         if(var_502)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_423[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_877,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_810,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1014,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_423[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_424.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_424[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1058.splice(var_1058.indexOf(this),1);
            --var_604;
            var_423 = null;
            var_729 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_359.length ? getAssetByName(var_359[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1185));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_424)
         {
            _loc3_ = AssetTypeDeclaration(var_424[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_729[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_503.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_423[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_359.splice(var_359.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_424[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
