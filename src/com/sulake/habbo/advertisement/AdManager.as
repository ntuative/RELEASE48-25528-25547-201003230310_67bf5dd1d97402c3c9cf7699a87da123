   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_414,0,0,_loc4_,var_1537,var_864,var_863));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2076 = int(_config.getKey("interstitial.interval","30000"));
         var_2078 = int(_config.getKey("interstitial.show.time","5000"));
         var_1536 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1537 = _loc2_.clickUrl;
         if(var_1288 != "" && var_1537 != "")
         {
            _loc3_ = var_1288;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1287 = _loc2_.imageUrl;
         var_2077 = _loc2_.clickUrl;
         var_710 = getTimer();
         if(var_1287 != "")
         {
            _loc3_ = var_1287;
            ...
            var_227.start();
            _loc4_ = new URLRequest(var_1287);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_387,0,0,param1.bitmapData,var_2077));
            var_710 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_863 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1536 > 0 && var_1535 >= var_1536)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_710;
         if(_loc1_ > var_2076)
         {
            ++var_1535;
      ...
      {
         var_315 = param2 as IHabboCommunicationManager;
         if(var_315 == null)
         {
            return;
         }
         _connection = var_315.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_456));
         }
      }
