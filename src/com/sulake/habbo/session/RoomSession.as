package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_998:UserDataManager;
      ...
      {
         if(var_32 == RoomSessionEvent.const_335 && _connection != null)
         {
            var_32 = RoomSessionEvent.const_97;
            if(isPrivateRoom)
            {
      ...
      {
         return var_998 as IUserDataManager;
      }
