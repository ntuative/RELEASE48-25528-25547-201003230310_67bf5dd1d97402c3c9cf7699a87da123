package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1030:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_91 = var_586.height;
         var_1031 = param5;
         var_850 = param6;
         var_223 = Math.floor(var_1031 / _thumbWidth);
         var_17 = new BitmapData(var_1031,var_850);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_223 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_223 - param1.x - 1;
         ...
         if(var_17.height < var_850)
         {
            _loc12_ = new BitmapData(var_17.width,var_850);
      ...
      private function getList() : Array
      {
         ...
         if(var_1030 != null)
         {
            _loc1_ = var_1030.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_489 = resolveRowCountFromList();
         if(var_489 == 0)
         {
            var_17 = new BitmapData(var_1031,var_850);
            return;
         }
         var_17 = new BitmapData(Math.max(var_223 * _thumbWidth,var_1031),Math.max(var_489 * var_91,var_850),true,16777215);
         var_17.fillRect(var_17.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_489)
         {
            _loc4_ = 0;
            while(_loc4_ < var_223)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_223 && var_17.height < _loc3_.y * var_91)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_223 - 1),var_91);
         _loc2_.copyPixels(var_17,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_223 - 1),0,_thumbWidth,var_17.height);
         _loc2_.copyPixels(var_17,_loc4_,new Point(0,var_91),null,null,true);
         _loc4_ = new Rectangle(0,var_91,_thumbWidth * (var_223 - 1),0 - var_91);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_223));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_223);
         var _loc3_:int = param1 % var_223;
         return new Point(_loc3_,_loc2_);
      }
