package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_328:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_226,onObjectPlaced);
         var_525 = new Timer(const_1136,1);
         var_525.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_47.getSubCategoryViewId() == InventorySubCategory.const_238;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_442.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_442.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_605)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_226,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_525 != null)
            {
               var_525.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_525.stop();
               var_525 = null;
            }
            if(var_140 != null)
            {
               var_140.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_140.stop();
               var_140 = null;
            }
            if(var_748 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_748 == null)
         {
            var_748 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_748.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_238:
               ...
               break;
            case InventorySubCategory.const_905:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_140 = new Timer(param1,1);
            var_140.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_140.start();
         }
         else
         {
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_473);
         ...
         if(param1 == InventoryCategory.const_72 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_328:
                  var_47.toggleInventoryPage(InventoryCategory.const_135);
            }
         }
      }
      ...
      {
         if(var_914 && param1.type == RoomEngineObjectEvent.const_226)
         {
            var_47.showView();
            var_914 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_338 || _loc3_.category == FurniCategory.const_300 || _loc3_.category == FurniCategory.const_318)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_442.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_442 = new Map();
         var_442.add(const_42,new Array());
         var_442.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
