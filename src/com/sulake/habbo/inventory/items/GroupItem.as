package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_369:BitmapData;
      
      private const const_1433:Number = 0.2;
      
      protected var var_1374:Boolean;
      
      private const const_1434:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_605)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1560));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1434;
               _loc1_.blend = const_1434;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1374 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2264;
               _loc5_.visible = true;
            }
            else
            {
