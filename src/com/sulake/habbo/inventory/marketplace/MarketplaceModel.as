package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_213 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_213.ref));
         method_2();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_213 is FloorItem ? 1 : 2;
         var_1912 = _loc2_;
         var_1911 = var_213.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_213.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1478,var_1477);
         }
      }
      ...
      {
         if(param1 != var_1912 || param2 != var_1911)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1877);
      }
      ...
      {
         if(var_47 != null && false && var_213 != null)
         {
            var_47.furniModel.removeLockFrom(var_213.id);
            var_213 = null;
         }
      }
