package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_902:IRoomSession;
      ...
      private const const_1654:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_97,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_104,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_397,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_104:
               var_902 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_397:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_659));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_46.getValue(InventoryCategory.const_72));
      }
      ...
      {
         var_152.clubPeriods = param1;
         var_152.clubDays = param2;
         var_152.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_135));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_828));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1654);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_321));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_238:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_901.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_901.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_238));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_332 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_901.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_152.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_46.getValue(InventoryCategory.const_473) as MarketplaceModel;
      }
      ...
      {
         return var_152.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_152.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_274));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_97,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_104,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_397,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_473,_loc3_);
         ...
         var_46.add(InventoryCategory.const_72,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_332);
         var_46.add(InventoryCategory.const_274,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_46.add(InventoryCategory.const_659,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_332);
         var_46.add(InventoryCategory.const_321,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_46.add(InventorySubCategory.const_238,_loc8_);
         ...
         var_46.add(InventoryCategory.const_135,_loc10_);
