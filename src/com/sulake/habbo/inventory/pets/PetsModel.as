package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_135 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1133 && param1.type == RoomEngineObjectEvent.const_226)
         {
            var_47.showView();
            var_1133 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1133 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_301,_loc3_.figure);
            var_47.closeView();
            return;
         }
      ...
      {
         if(var_957.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
