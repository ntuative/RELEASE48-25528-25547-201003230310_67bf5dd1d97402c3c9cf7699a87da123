package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_293:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_523 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_548 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_548.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_293 != null)
         {
            var_293.setSelected(false);
         }
         var_293 = param1;
         if(var_293 != null)
         {
            var_293.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_293.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_548.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_523.removeGridItem(_loc2_.window);
         if(var_293 == _loc2_)
         {
            var_293 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_548.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_523.addGridItem(_loc2_.window);
            var_548.add(param1.id,_loc2_);
            if(var_293 == null)
            {
               selectFirst();
            }
