package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_1159:IWindowContainer;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1159);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_651 == InventoryCategory.const_135)
            {
               toggleCategoryView(InventoryCategory.const_135);
            }
            else if(var_651 == InventoryCategory.const_72)
            {
               toggleCategoryView(InventoryCategory.const_72);
            }
            else if(var_47 != null)
            {
               var_47.toggleInventoryPage(InventoryCategory.const_72);
            }
         }
      }
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_183 != null && var_774)
            {
               var_183.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_183 != null)
         {
            var_183.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_183 != null)
         {
            var_183.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_616,HabboToolbarIconEnum.INVENTORY,var_13 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_183 != null && var_774)
         {
            var_183.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_774 = false;
         }
         var_47.inventoryViewOpened(var_652);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_651 || !var_47.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_183 != null && var_774)
