package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_751:uint = 4284532064;
      
      private static const const_750:uint = 2577770;
      ...
      private var var_333:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_333 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_178)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_885)
            {
            ...
            var_333.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_411);
            var_333.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_167)
            {
               var_167.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_167.stop();
               var_167 = null;
            }
            if(var_333 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1438 == null)
         {
            var_1438 = createMinimizedWindow();
         }
         if(!var_1769)
         {
            return var_60;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_167 == null)
         {
            var_167 = new Timer(1000,3);
            var_167.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_167.reset();
         var_167.repeatCount = 3;
         var_167.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_60)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_751) : uint(const_750);
            }
