package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_796:uint = 11;
       
      
      private var var_238:LatencyTracker = null;
      
      private var var_239:PerformanceTracker = null;
      
      private var var_274:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_137:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1085:int = -1;
      
      private var var_918:LagWarningLogger = null;
      
      private var var_919:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_239 = new PerformanceTracker();
         var_238 = new LatencyTracker();
         var_918 = new LagWarningLogger();
         var_1360 = new Array(const_796);
         var _loc4_:int = 0;
         while(_loc4_ < const_796)
         {
            var_1360[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1288,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1335,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_599,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_900,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1211);
               break;
            case HabboCommunicationEvent.const_533:
               trackLoginStep(HabboLoginTrackingStep.const_1149,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_223:
               trackLoginStep(HabboLoginTrackingStep.const_223);
               break;
            case HabboCommunicationEvent.const_175:
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_239 != null)
            {
               var_239.connection = param1;
            }
            if(var_238 != null)
            {
               var_238.communication = _communication;
               var_238.connection = param1;
            }
            if(var_918 != null)
            {
               var_918.connection = param1;
            }
         }
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_334:
      ...
      {
         var_157 = IHabboConfigurationManager(param2);
         if(var_157)
         {
            Component(var_157).events.addEventListener(HabboConfigurationEvent.const_170,onConfigurationLoaded);
            if(var_238 != null)
            {
               var_238.configuration = var_157;
            }
            if(var_239 != null)
            {
               var_239.configuration = var_157;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_274.events.addEventListener(AdEvent.const_414,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2232)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1270);
            var_2232 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_900,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_533,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_175,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_215,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_551,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_59,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_400,onHotelViewEvent);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_919)
            {
               var_919.release(new IIDHabboWindowManager());
               var_919 = null;
            }
            if(var_274)
            {
            ...
            if(var_176)
            {
               if(true)
               {
                  ...
                  Component(var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_334,onFriendlistTrackingEvent);
               }
            ...
            if(var_137)
            {
               if(true)
               {
                  var_137.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_137.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_137.release(new IIDHabboHelp());
               var_137 = null;
            }
            if(_roomEngine)
            {
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_157)
         {
            if(var_918 != null)
            {
               var_918.configure(var_157);
            }
            Component(var_157).events.removeEventListener(HabboConfigurationEvent.const_170,onConfigurationLoaded);
         }
      }
      ...
      {
         var_137 = param2 as IHabboHelp;
         var_137.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_137.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_941);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_941,onCoreRunning);
         }
      }
      ...
      {
         var_919 = IHabboWindowManager(param2);
         if(var_919)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1085 > -1 && _loc2_ < var_1085)
         {
            ++var_1585;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1585);
         }
         if(var_1085 > -1 && _loc2_ - var_1085 > 15000)
         {
            ++var_1586;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1586);
         }
         var_1085 = _loc2_;
         if(var_239 != null)
         {
            var_239.update(param1);
         }
         if(var_238 != null)
         {
            var_238.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_157 != null && Boolean(var_157.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_176).events.addEventListener(HabboFriendListTrackingEvent.const_334,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_157)
            {
               if(var_157.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_157.getKey("client.fatal.error.url");
                  ...
                  if(var_239 != null)
                  {
                     _loc4_["null"] = var_239.flashVersion;
                     _loc4_["null"] = var_239.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_551)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1355);
         }
         else if(param1.type == HabboHotelViewEvent.const_400)
         {
