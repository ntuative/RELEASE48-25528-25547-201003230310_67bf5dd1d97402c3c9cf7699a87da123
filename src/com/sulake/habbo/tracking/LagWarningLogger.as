package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1359 || var_1513 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1514 == 0 || _loc1_ - var_1514 > var_1513)
         {
            if(_connection != null)
            {
      ...
      {
         var_1359 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1513 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
