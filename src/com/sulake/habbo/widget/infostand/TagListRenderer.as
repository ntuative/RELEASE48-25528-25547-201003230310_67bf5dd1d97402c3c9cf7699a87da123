package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1627:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1362 != null && var_1362.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_106);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_776 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_776 += param1.height + const_1626;
            return fit(param1);
         }
         param1.offset(_offsetX,var_776);
         _offsetX += param1.width + const_1627;
         return true;
      }
