package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1638:String = "level";
      
      private var var_102:IItemListWindow;
      
      private const const_1640:String = "energy";
      
      private var var_1236:Map;
      
      private const const_1637:String = "nutrition";
      
      private var var_59:IItemListWindow;
      
      private const const_1639:uint = 3355443;
      
      private var var_231:IBorderWindow;
      
      private const const_1641:int = 158;
      
      private const const_1644:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_257:PetCommandTool;
      
      private const const_1642:uint = 11184810;
      
      private const const_1636:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_231 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_231 != null)
         {
            var_102 = var_231.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_231.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_231.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_102 == null || var_231 == null || var_59 == null)
         {
            return;
         }
         ...
         var_231.height = NaN;
         _window.width = Math.max(var_231.width,var_59.width);
      ...
      private function openTrainView() : void
      {
         if(var_257 == null)
         {
            var_257 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1236.getValue(var_668) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_257.showWindow(true);
            var_257.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1638,param1.level,param1.levelMax);
         updateStateElement(const_1636,param1.experience,param1.experienceMax);
         updateStateElement(const_1640,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_668 = param1.id;
         var_1236.remove(param1.id);
         var_1236.add(param1.id,param1);
         if(var_257 && var_257.isVisible() && param1.isOwnPet)
         {
            var_257.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_257.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_396,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1641,const_1644,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1642);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1639);
