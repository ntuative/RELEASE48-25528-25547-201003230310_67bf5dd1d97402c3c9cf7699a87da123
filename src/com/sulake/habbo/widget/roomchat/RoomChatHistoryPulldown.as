package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_788:int = 3;
      
      private static const const_776:int = 150;
      
      private static const const_775:int = 250;
      ...
      private var var_1526:BitmapData;
      ...
      private var var_1524:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_37 = param3;
         var_2053 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1526 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_2052 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1524 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1525 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_2051 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_2049 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_71 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_40,HabboWindowParam.const_66,new Rectangle(0,0,param3.width,param3.height - const_71),null,0,0) as IBitmapWrapperWindow;
         var_37.addChild(var_71);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_57,HabboWindowStyle.const_40,HabboWindowParam.const_41,new Rectangle(0,0 - const_71,param3.width,const_71),null,0) as IWindowContainer;
         var_37.addChild(_window);
         var_94 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_379,HabboWindowStyle.const_39,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_71),null,0) as IRegionWindow;
         if(var_94 != null)
         {
            var_94.background = true;
            var_94.mouseTreshold = 0;
            var_94.addEventListener(WindowMouseEvent.const_49,onPulldownMouseDown);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_369:
               var_71.blend += param1 / const_775;
               _window.blend += param1 / const_775;
               if(false)
               {
                  state = const_311;
               }
               break;
            case const_788:
               var_71.blend = 0 - param1 / const_776;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_94 != null)
         {
            var_94.x = 0;
            var_94.y = 0 - const_71;
            var_94.width = 0 - var_2048;
         }
         if(var_71 != null)
         {
            var_71.rectangle = var_37.rectangle;
            var_71.height = 0 - const_71;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_2050 == _window.width)
         {
            return;
         }
         var_2050 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_2053.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1526.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1526.clone(),_loc9_);
