package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_341:int = 10;
      
      private static const const_1049:Number = 18;
      
      private static const const_1414:Number = 10;
      
      private static const const_1415:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_966,var_967,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_966,var_647,var_967,_roomId,_roomCategory,param1);
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         var_966 = param1.userId;
         var_647 = param1.userName;
         var_967 = param1.userCategory;
         _message = param1.text;
         var_1151 = param1.userX;
         var_187 = param1.userImage;
         var_965 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_81,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         if(var_187 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_379 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_965 != 0)
            {
               _loc30_ = uint(var_965 >> 16 & 255);
               _loc31_ = uint(var_965 >> 8 & 255);
               _loc32_ = uint(var_965 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_341;
            }
            else
            {
               _loc19_.text = var_647 + ":";
               _loc19_.y += var_379;
               _loc19_.width = _loc19_.textWidth + const_341;
               _width += _loc19_.textWidth + const_341;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1152 == RoomWidgetChatUpdateEvent.const_270)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_647);
            }
            else if(var_1152 == RoomWidgetChatUpdateEvent.const_259)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_647);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_341 + _loc20_.textWidth + const_484;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_966,var_967,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_966,var_967,_roomId,_roomCategory,param1);
      }
