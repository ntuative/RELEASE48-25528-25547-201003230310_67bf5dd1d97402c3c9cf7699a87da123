package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private function method_5(param1:RoomWidgetDoorbellEvent) : void
      {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_709,method_5);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_122,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_709,method_5);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_122,onDoorbellHandled);
