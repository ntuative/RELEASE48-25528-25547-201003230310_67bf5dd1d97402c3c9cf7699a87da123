package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_641[var_958] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_291)
         {
            ...
            var_291 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_291.center();
            var_291.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_958;
         if(var_958 < var_641.length)
         {
            _loc1_ = var_641[var_958] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_641.length);
                  _loc2_.text = _loc6_;
               }
