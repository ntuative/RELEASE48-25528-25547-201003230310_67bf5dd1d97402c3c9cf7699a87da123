      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_879);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_958));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_645);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_844));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_325);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_881));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_678);
               break;
            case "news":
               if(false && false)
               {
