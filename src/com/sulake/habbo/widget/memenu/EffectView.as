package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_822:IWindow;
      
      private var var_820:IWindow;
      
      private var var_427:Number;
      
      private var var_821:ITextWindow;
      
      private var var_170:IWidgetAvatarEffect;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_822 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_170.duration);
               var_822.width = _loc2_ * var_427;
            }
            else
            {
               var_822.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_820 = _window.findChildByName("effect_hilite");
            var_820.visible = false;
         }
         var_821 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_822 = _window.findChildByName("loader_bar");
         if(var_822 != null)
         {
            var_427 = var_822.width;
            var_167.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_170.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_821 != null)
         {
            var_821.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_821.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
