package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_645:String = "me_menu_effects_view";
      
      public static const const_112:String = "me_menu_top_view";
      
      public static const const_1162:String = "me_menu_rooms_view";
      
      public static const const_879:String = "me_menu_dance_moves_view";
      ...
      private var var_593:Boolean = false;
      ...
      public function MeMenuWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         {
            var_2060 = param5.getKey("client.news.embed.enabled","false") == "true";
         }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_624,onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_671,onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_623,onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_632,onToolbarClicked);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_303,onUpdate);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_552,onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_192,onAvatarDeselected);
         param1.addEventListener(RoomWidgetHabboClubUpdateEvent.const_207,onHabboClubEvent);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(var_36.window.name == const_678)
         {
      ...
      private function onCreditBalance(param1:RoomWidgetCreditBalanceUpdateEvent) : void
      {
         ...
         var_1533 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",var_1533.toString());
      }
      
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         var _loc2_:* = null;
         if(!(var_270 && var_36.window.name == const_325))
         {
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_624,onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_671,onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_623,onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_632,onToolbarClicked);
         ...
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_207,onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarActionUpdateEvent.const_521,onAvatarActionEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_552,onAvatarEditorClosed);
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_415:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + var_270 + " view: " + var_36.window.name);
               if(var_270 != true || var_36.window.name != const_112)
               {
                  return;
               }
               (var_36 as MeMenuMainView).setIconAssets("clothes_icon",const_112,"clothes_highlighter_blue");
               break;
      ...
      {
         var _loc2_:* = var_1285 > 0;
         var_1285 = param1.daysLeft;
         var_2062 = param1.periodsLeft;
         var_2061 = param1.pastPeriods;
         var_2059 = param1.allowClubDances;
      ...
      {
         if(var_36 != null && var_36.window.name != const_325)
         {
            hide();
         }
      }
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("me_menu_main_container","",HabboWindowType.const_1171,HabboWindowStyle.const_868,HabboWindowParam.const_39,new Rectangle(0,0,170,260)) as IWindowContainer;
      ...
      private function onUpdateEffects(param1:RoomWidgetUpdateEffectsUpdateEvent) : void
      {
         ...
         if(var_36 != null && var_36.window.name == const_645)
         {
      ...
      public function updateSize() : void
      {
         if(var_36 != null)
         {
            var_1041.x = var_36.window.width + 10;
            var_1041.y = var_36.window.height;
            var_36.window.x = 5;
            var_36.window.y = 0;
      ...
      {
         var _loc2_:RoomWidgetToolbarMessage = new RoomWidgetToolbarMessage(RoomWidgetToolbarMessage.const_557);
      ...
      private function show() : void
      {
         ...
         changeView(const_112);
         var _loc1_:RoomWidgetToolbarMessage = new RoomWidgetToolbarMessage(RoomWidgetToolbarMessage.const_562);
