package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_644:MeMenuSettingsViewSlider;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_561);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_535);
         }
      ...
      {
         var_643 = param1.volume;
         if(var_644 != null)
         {
            var_644.setValue(var_643);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            var_1404 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1405 = (_loc5_.content as BitmapData).clone();
         }
         var_644 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_581));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_643 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1402);
               }
               break;
            case "sounds_on":
               if(var_643 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1405);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1404);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1402);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1403);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1405);
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               _widget.changeView(MeMenuWidget.const_112);
               break;
            default:
