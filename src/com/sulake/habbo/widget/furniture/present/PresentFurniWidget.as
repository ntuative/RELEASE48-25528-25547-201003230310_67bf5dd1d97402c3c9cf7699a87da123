package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private var var_216:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_405,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_446,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_406,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_405,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_446,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_406,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_61:
               hideInterface();
               var_216 = false;
               var_147 = param1.objectId;
               var_193 = param1.text;
               var_47 = param1.controller;
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_446:
               if(!var_216)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_406:
               if(!var_216)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_360:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_405:
               if(!var_216)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_723,var_147);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_57,HabboWindowStyle.const_40,0 | 0,new Rectangle(const_1072,const_1071,2,2),null,0) as IWindowContainer;
