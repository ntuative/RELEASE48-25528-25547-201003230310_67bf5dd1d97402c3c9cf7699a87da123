package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_757:int = 16777215;
      
      public static const const_1195:int = 10066329;
      ...
      private var var_1221:String = null;
      
      private var var_1860:int = 255;
      ...
      private var var_1863:int = -1000;
      
      private var var_999:uint = 16777215;
      
      private var var_1861:Boolean = true;
      ...
      private var var_573:Rectangle = null;
      
      private var var_1858:int = 255;
      
      private var var_1862:Boolean = false;
      
      private var var_1857:int = 255;
      ...
      private var var_397:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_397 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_853);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_964);
         var _loc7_:int = 0;
         while(_loc7_ < var_75.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1341)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_214,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_214 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_573 == null)
         {
            var_573 = super.boundingRectangle;
         }
         return new Rectangle(var_573.x,var_573.y,var_573.width,var_573.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_397.maskCount)
         {
            _loc6_ = var_397.getMaskType(_loc5_);
            _loc7_ = var_397.getMaskLocation(_loc5_);
            _loc8_ = var_397.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_101.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_214 || _loc3_.type == RoomPlane.const_189 && _loc8_ == RoomPlaneBitmapMaskData.const_194)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1462;
                        if(var_75.getPlaneType(_loc9_) == RoomPlaneData.const_142)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1171)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_982 || _loc9_.y != var_1762 || _loc9_.z != var_1761 || param1.scale != var_1764))
            {
               var_982 = _loc9_.x;
               var_1762 = _loc9_.y;
               var_1761 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_866);
            if(_loc10_ != var_1859)
            {
            ...
            {
               var_999 = _loc11_;
               var_1857 = var_999 & 255;
               var_1858 = var_999 >> 8 & 255;
               var_1860 = var_999 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1863 + const_1631 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1863 = _loc7_;
         if(var_159 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_714);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_677);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_571);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1861 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_980));
            var_159 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_396.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_396[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_189)
            {
               if(var_1861)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1857 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1858 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1860 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_101.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_214 && param2 != null)
               {
                  _loc5_.id = param2;
               }
