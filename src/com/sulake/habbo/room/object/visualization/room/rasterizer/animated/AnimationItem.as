package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class AnimationItem
   {
      ...
      private var var_1035:Number = 0;
      
      private var var_1034:Number = 0;
      ...
      {
         var _loc6_:Number = var_81;
         var _loc7_:Number = _y;
         if(param3 > 0)
         {
            _loc6_ += var_1035 / param3 * param5 / 1000;
         }
         if(param4 > 0)
         {
            _loc7_ += var_1034 / param4 * param5 / 1000;
         }
