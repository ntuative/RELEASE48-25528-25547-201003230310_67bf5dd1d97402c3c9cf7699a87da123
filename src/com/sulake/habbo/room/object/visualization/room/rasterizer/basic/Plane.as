package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_295.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_655 = var_295.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_655 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_295 != null)
         {
            ...
            {
               _loc1_ = var_295.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
