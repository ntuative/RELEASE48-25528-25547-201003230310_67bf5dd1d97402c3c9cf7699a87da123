package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_487:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_487 = var_267.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_487 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_267 != null)
         {
            ...
            {
               _loc1_ = var_267.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function method_7(param1:int, param2:int) : SizeData
      {
         var _loc3_:* = null;
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_267.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            _loc9_ = method_7(_loc7_,_loc8_);
            if(_loc9_ == null)
            {
               return false;
            }
            ...
            var_267.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
