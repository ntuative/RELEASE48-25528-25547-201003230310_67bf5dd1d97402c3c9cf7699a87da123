package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1408:Number = Math.sqrt(0.5);
      ...
      private var var_1327:Boolean = true;
      ...
      protected var var_2273:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_610[param1] = _loc3_;
            var_609[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1001:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_824:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_2164 != param1 || var_2167 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_610[_loc3_] = "";
               var_609[_loc3_] = false;
               _loc3_--;
            }
            var_2164 = param1;
            var_2167 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2166 != param1 || var_2165 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2274 = _loc3_.getNumber(RoomObjectVariableEnum.const_224);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_231));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1561 = _loc3_.getString(RoomObjectVariableEnum.const_326);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_287 != _loc3_.getUpdateID() || param1 != var_208 || param2 != var_2273)
         {
