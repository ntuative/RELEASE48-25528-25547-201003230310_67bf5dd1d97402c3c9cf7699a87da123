package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_746:int = 15;
      
      private static const const_1040:int = 2;
      
      private static const const_345:int = 2;
      
      private static const const_745:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_947[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_949[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_947 = new Array();
         var_947.push(Math.random() * _loc2_ * 1.5);
         var_947.push(Math.random() * _loc2_ * 1.5);
         var_950 = new Array();
         var_950.push(1);
         var_950.push(-1);
         var_948 = new Array();
         var_948.push(const_1040);
         var_948.push(const_1041);
         var_949 = new Array();
         var_949.push(getRandomAmplitudeFactor());
         var_949.push(getRandomAmplitudeFactor());
      }
