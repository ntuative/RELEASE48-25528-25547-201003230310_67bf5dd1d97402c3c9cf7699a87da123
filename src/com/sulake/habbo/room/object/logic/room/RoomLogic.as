package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1414:int = 1500;
      
      private var var_1413:int = 255;
      
      private var var_1415:int = 255;
      
      private var var_1150:uint = 16777215;
      
      private var var_964:uint = 16777215;
      
      protected var var_75:RoomPlaneParser = null;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_609:
                  _loc2_.setString(RoomObjectVariableEnum.const_677,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_703:
                  _loc2_.setString(RoomObjectVariableEnum.const_714,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_665:
                  _loc2_.setString(RoomObjectVariableEnum.const_571,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_455:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_194)
                  {
                     _loc8_ = "null";
                  }
                  var_397.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_607:
                  _loc7_ = var_397.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_397.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_866,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_980,int(_loc5_.bgOnly));
            var_1150 = _color;
            var_1413 = var_1187;
            var_964 = _loc11_;
            var_1415 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_75.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_853,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_75.planeCount)
         {
         ...
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_75.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_75.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_75.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_75.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_75.getPlaneNormal(_loc5_);
         var _loc13_:int = var_75.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1281,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1235,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1225,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_149 || _loc13_ == RoomPlaneData.const_247)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_773)
         {
            ...
            {
               _loc7_ = var_1150 >> 16 & 255;
               _loc8_ = var_1150 >> 8 & 255;
               _loc9_ = var_1150 & 255;
               _loc10_ = var_964 >> 16 & 255;
               _loc11_ = var_964 >> 8 & 255;
               _loc12_ = var_964 & 255;
               _loc13_ = (_loc2_ - var_773) / var_1414;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1413 + (var_1415 - var_1413) * _loc13_;
               _color = _loc3_;
               var_1187 = _loc4_;
            }
