package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private var var_1185:Number = 0;
      
      private var var_993:Number = 0;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc4_ != null)
         {
            if(_loc2_ != null)
            {
               _loc2_.setString(RoomObjectVariableEnum.const_960,_loc4_.itemData);
            }
            return;
         }
         var_665 = false;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_314,var_993,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_480,var_995,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_655,var_994,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1378,var_1814,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1282,var_1813,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_806,var_1185,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_582,var_210,true);
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.ROLL_OUT:
               if(var_665)
               {
                  ...
                  if(eventDispatcher != null && _loc9_ != null && _loc9_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_324,_loc6_,_loc7_));
                  }
                  var_665 = false;
               }
               break;
            case MouseEvent.DOUBLE_CLICK:
               ...
               if(eventDispatcher != null && _loc9_ != null && _loc9_.indexOf("http") == 0)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_442,_loc6_,_loc7_));
               }
