package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_754:String = "selection_arrow";
      
      private static const const_752:String = "tile_cursor";
      ...
      private static const const_1068:String = const_342;
      
      private static const const_1422:int = 0;
      
      private static const const_753:int = 1;
      ...
      private var var_987:IEventDispatcher = null;
      
      private var var_1180:Map = null;
      ...
      private var var_168:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_465 = [];
         var_467 = [];
         var_1782 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1787 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_389 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_31:
                     if(var_465.indexOf(_loc4_) == -1)
                     {
                        var_465.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_29:
                     if(var_467.indexOf(_loc4_) == -1)
                     {
                        var_467.push(_loc4_);
                     }
                     break;
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_320,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_121 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_168 != null && var_168.hasWorldType(const_278 + param1))
         {
            return var_168.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_466.add(_loc10_,_loc11_);
                              if(var_465.indexOf(_loc14_) < 0)
                              {
                                 var_465.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_467.indexOf(_loc14_) < 0)
                              {
                                 var_467.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_334 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_334.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_568.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_342,const_488,ROOM_CONTENT,const_752,const_754];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1782.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_181 && _loc5_ != RoomObjectLogicEnum.const_121)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_466.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_465.indexOf(param1) >= 0)
         {
            return const_342;
         }
         if(var_467.indexOf(param1) >= 0)
         {
            return const_488;
         }
         if(var_168 != null && (var_168.type == param1 || var_168.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1068;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1276);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1787.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1180.add(_loc5_,_loc8_);
               var_168 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_320,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_1781)
         {
            ...
            if(var_987 != null)
            {
               var_987.dispatchEvent(new Event(const_539));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_168 != null)
         {
            return var_168.getWorldHeightScale(const_278 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_987 = param1;
            var_1786 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1785 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1784 = param2.getKey("public.room.dynamic.download.url","");
            var_1783 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_32 = const_753;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_334.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_181 && _loc5_ != RoomObjectVisualizationEnum.const_121)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1180.getValue(param1) != null)
         {
            var_168 = var_1180.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_371,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_168 != null)
         {
            return var_168.getWorldScale(const_278 + param1);
         }
         return 32;
      }
