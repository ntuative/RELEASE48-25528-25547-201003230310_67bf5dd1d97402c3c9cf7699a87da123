package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_774:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1104:String = "tile_cursor";
      ...
      private var var_585:NumberBank;
      ...
      private var var_62:RoomObjectEventHandler = null;
      
      private var var_699:RoomMessageHandler = null;
      
      private var var_698:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_303 = new Map();
         var_585 = new NumberBank(1000);
         var_1027 = new Map();
         var_304 = new Map();
         var_62 = new RoomObjectEventHandler(this);
         var_699 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_62 != null)
         {
            ...
            {
               return var_62.deleteWallItem(var_108,var_107,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_549) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_613) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_545) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_660) + 0.5;
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var_62.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_62 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_29)
            {
               return var_62.modifyWallItemData(var_108,var_107,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_698 != null)
         {
            var_698.release(new IIDRoomRendererFactory());
            var_698 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_615);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_598);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_553);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_973);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_952);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_816) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_869);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_455,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_666,var_108,var_107,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_62 != null)
         {
            return var_62.modifyRoomObject(var_108,var_107,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_609,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_703,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_665,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_62 != null)
         {
            var_62.handleRoomObjectEvent(param1,var_108,var_107);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_224,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_313,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_326,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_929,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1003,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_826,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_240,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
      ...
      {
         if(var_26 == null || var_393 == null || var_39 == null || var_698 == null || _communication == null || _habboConfiguration == null || !var_2020)
         {
            return;
         }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1374,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_39.getRoom(getRoomIdentifier(var_108,var_107));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1273);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1273);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_393;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_203,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_431,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_254,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_663,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_117,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_107,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_109,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_91,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_392,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_390,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_391,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_375,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_367,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_353,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_420,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectMoveEvent.const_399,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_352,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_268,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_442,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_293,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_324,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_445,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_855,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_481,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_463,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_108,var_107);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_565) != 0)
         {
            return false;
         }
         if(var_62 != null)
         {
            return var_62.initializeRoomObjectInsert(var_108,var_107,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_488 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_509,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_240,param1,param2,param3,RoomObjectCategoryEnum.const_36));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_453);
                     break;
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_322);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_539)
         {
            var_2020 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_224,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_313,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_326,_loc11_,true);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_240,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_274.events.addEventListener(AdEvent.const_414,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_774) as Sprite;
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(var_62 != null)
         {
            var_62.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_62 != null)
         {
            return var_62.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_698,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_698 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc11_:int = var_585.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_29:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_224,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_453,param8);
               break;
            case RoomObjectCategoryEnum.const_36:
            ...
            case RoomObjectCategoryEnum.const_63:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_142,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_677,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_714,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_571,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_455,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1027.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_903,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_585.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_773,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,param1);
         if(_loc9_ != null)
         {
            var_1273 = param1;
            var_1509 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1509 - _loc12_.width / 2;
               _loc11_.y = var_1510 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_465,var_108,var_107,-1,RoomObjectCategoryEnum.const_232));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_62 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_280,const_494);
                  var_62.handleRoomObjectEvent(_loc14_,var_108,var_107);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_108,var_107,param1,param2,new Vector3d(),1,null);
         }
         else if(var_11 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_108,var_107,var_1273);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1509 - _loc6_.data.width / 2;
               _loc11_.y = var_1510 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_289,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_975,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_833,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_807,RoomObjectVariableEnum.const_289,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_539,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_62 != null)
         {
            var_62.cancelRoomObjectInsert(var_108,var_107);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_903);
               ...
               var_585.freeNumber(_loc10_ - 1);
               _loc13_ = var_1027.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_108,var_107,const_280,RoomObjectCategoryEnum.const_63,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_934,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_565,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_878,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_280,const_494,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_565,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_615,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_549,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_545,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_613,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_660,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_964,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_609,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_703,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_665,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_455,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_194);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_553,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_598,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_553,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_973,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_952,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_773,const_1104,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
