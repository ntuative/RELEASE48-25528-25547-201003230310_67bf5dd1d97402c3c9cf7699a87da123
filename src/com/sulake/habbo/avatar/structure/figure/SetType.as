package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         var_1928 = parseInt(param1.@paletteid);
         var_1929 = Boolean(parseInt(param1.@mandatory));
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in param1["HabboWindowManagerCom_habbo_skin_button_radio_black_xml"])
         {
