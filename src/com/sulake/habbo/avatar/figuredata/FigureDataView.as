package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_1076:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1076 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_617 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_617 && var_1076)
         {
            var_617.bitmap = new BitmapData(var_617.width,var_617.height,true,16777215);
            var_617.bitmap.copyPixels(var_1076,var_1076.rect,new Point(0,0 - 0 - 8));
            var_617.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
