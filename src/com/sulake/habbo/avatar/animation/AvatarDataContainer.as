package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1491:Number = 1;
      
      private var _b:uint;
      
      private var var_1490:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         var_2122 = parseInt(_loc2_,16);
         var_2120 = parseInt(_loc3_,16);
         ...
         _colorTransform = new ColorTransform(var_1488,var_1490,var_1491,_alphaMultiplier);
         var_1057 = generatePaletteMapForGrayscale(var_2120,var_2122);
      }
      
      public function get reds() : Array
      {
         return var_1057.getValue("reds") as Array;
      }
      ...
      {
         return var_1057.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1057.getValue("greens") as Array;
      }
      ...
      {
         return var_1057.getValue("alphas") as Array;
      }
