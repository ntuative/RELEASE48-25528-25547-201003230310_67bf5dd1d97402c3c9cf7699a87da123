package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_704:String = "bodypart";
      
      public static const const_409:String = "fx";
      ...
      private var var_1443:IActiveActionData;
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_1780 = parseInt(param2.@frame);
         _dx = parseInt(param2.@dx);
         var_1232 = parseInt(param2.@dy);
         var_1233 = parseInt(param2.@dz);
         ...
         if(param5 != null)
         {
            var_1443 = new ActiveActionData(param5.state,_loc7_);
            var_1443.definition = param5;
         }
      }
