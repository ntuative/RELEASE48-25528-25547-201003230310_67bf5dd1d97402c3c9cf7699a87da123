package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1534:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         super();
         var_495 = new Matrix4x4();
         var_709 = new Dictionary();
         var_1534 = new AvatarSet(param1.avatarset[0]);
         var_119 = new Dictionary();
         ...
         for each(_loc4_ in param1.type)
         {
            ...
            var_709[String(_loc4_.@id)] = _loc12_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_495 = var_495.identity().rotateY(param3);
            return _loc5_.getParts(var_495,var_862,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1534.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_709[param1] as Dictionary;
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = var_119[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_495 = var_495.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_495);
            _loc11_ = _loc8_.getDistance(var_862);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_709[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1534.findAvatarSet(param1);
         if(_loc3_ != null)
         {
