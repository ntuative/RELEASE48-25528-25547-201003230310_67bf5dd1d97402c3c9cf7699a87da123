package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1657:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_680 >= 0 && var_171.length > var_680)
         {
            _loc2_ = var_171[var_680];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_171.length > param1)
         {
            _loc3_ = var_171[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_195.length)
         {
            ...
            {
               if(_loc7_.length > var_195[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_195[param2],param2);
         var_195[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_195[param1])
         {
            return null;
         }
      ...
      {
         return var_171[var_680] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_195 = new Array(param1.length);
         var _loc3_:int = 0;
