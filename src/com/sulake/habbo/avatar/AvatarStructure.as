package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_421:PartSetsData;
      
      private var var_2116:PartOffsetData;
      
      private var var_880:AvatarActionManager;
      
      private var var_175:IAssetLibrary;
      
      private var var_1056:IAssetLibrary;
      
      private var var_1373:Boolean = false;
      
      private var var_2117:AvatarRenderManager;
      
      private var var_420:FigureData;
      ...
      private var var_1555:AvatarStructureDownloadSet;
      
      private var var_724:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_175 = param2;
         var_1056 = param3;
         var_420 = new FigureData();
         var_421 = new PartSetsData();
         _animationData = new AnimationData();
         var_1555 = new AvatarStructureDownloadSet();
         var_724 = new AnimationManager();
         var_723 = param4;
         var_2116 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_880.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_723)
         {
            case AvatarType.const_81:
               _loc1_ = var_175.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_421.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_175.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_175.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_420.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_175.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_421.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_175.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_175.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_420.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_880.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_420.append(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_880.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_724.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_421.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_421.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1286[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_880.getDefaultActionType();
         var _loc9_:Array = var_421.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_724.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_420.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_420.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_421.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_421.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_81:
               if(var_175.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_175.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_175.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_175.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_723 + " ready to go!");
         if(var_723 == AvatarType.const_81)
         {
            var_421.getPartDefinition("ri").appendToFigure = true;
            var_421.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_81:
               if(var_175.hasAsset(_loc5_))
               {
                  var_175.removeAsset(var_175.getAssetByName(_loc5_));
               }
               var_1555.add(new AvatarStructureDownload(var_175,_loc5_,var_420));
               break;
            case AvatarType.PET:
         }
         var_1555.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_724.getAnimation(param1);
      }
      ...
      {
         var_880 = new AvatarActionManager(var_175,var_723);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1056.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1056.getAssetByName("dance" + _loc1_).content as XML;
            var_724.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1056.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1056.getAssetByName("fx" + _loc1_).content as XML;
            var_724.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_420.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_420.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_880.sortActions(param1);
      }
   }
}
