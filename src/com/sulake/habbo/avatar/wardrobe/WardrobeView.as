package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_968:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_650 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_968 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_650)
         {
            var_650.removeListItems();
         }
         if(var_968)
         {
            var_968.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_650)
               {
                  var_650.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_968)
            {
               var_968.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
