package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      private var var_294:IBitmapWrapperWindow;
      ...
      private function createView() : void
      {
         ...
         _view.visible = false;
         var_294 = _view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(var_380 && var_1163)
         {
            _loc5_ = var_47.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_92);
            _loc5_.setDirection(AvatarSetType.const_37,parseInt(FigureData.const_563));
         ...
         if(var_294)
         {
            if(false)
            {
               var_294.bitmap.dispose();
            }
            var_294.bitmap = new BitmapData(var_294.width,var_294.height,true,0);
            _loc7_ = (0 - _loc1_.width) / 2;
            _loc8_ = (0 - _loc1_.height) / 2;
            var_294.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_380 = var_47.figureData.getFigureString();
               var_654 = var_47.gender;
               var_47.handler.saveWardrobeOutfit(var_1428,this);
               updateView();
               break;
            case "get_button":
               if(var_380)
               {
                  var_47.loadAvatarInEditor(var_380,var_654,var_47.clubMemberLevel);
               }
         }
      }
   }
