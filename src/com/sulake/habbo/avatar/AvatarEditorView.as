package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1567:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_514:IFrameWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_2179:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         var_362 = new Timer(1000);
         var_362.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1567 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_47.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1568 == AvatarEditorSideCategory.WARDROBE || var_2179))
         {
            _loc4_ = "null";
         }
      ...
      public function dispose() : void
      {
         ...
         {
            var_362.stop();
            var_362.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_362 = null;
         }
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_514)
         {
            ...
            var_514 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_514.procedure = stripClubDialogEventProc;
            var_514.center();
         }
         else
         {
            var_514.visible = true;
            var_514.center();
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_692:
               break;
            case AvatarEditorSideCategory.const_365:
               _loc3_ = var_47.getSideContentWindowContainer(AvatarEditorSideCategory.const_365);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_246 = param1;
         var_1567.setSelected(var_1567.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1568 == AvatarEditorSideCategory.WARDROBE)
         {
            var_2179 = false;
            setSideContent(AvatarEditorSideCategory.const_692);
         }
         else
         {
