package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_49 == null)
         {
            var_49 = IWindowContainer(_navigator.getXmlWindow(var_1122));
            var_49.visible = false;
            var_49.setParamFlag(HabboWindowParam.const_41,true);
         ...
         var_49.x = _loc2_.x + var_1961 + param1.width;
