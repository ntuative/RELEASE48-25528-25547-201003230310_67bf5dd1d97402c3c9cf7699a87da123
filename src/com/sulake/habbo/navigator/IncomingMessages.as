package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboNavigator)
      {
         ...
         _loc2_.addHabboConnectionMessageEvent(new FlatAccessibleMessageEvent(method_9));
      ...
      private function onRoomSettingsSaved(param1:IMessageEvent) : void
      {
         ...
         _navigator.mainViewCtrl.reloadRoomList(Tabs.const_209);
      }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_167 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
