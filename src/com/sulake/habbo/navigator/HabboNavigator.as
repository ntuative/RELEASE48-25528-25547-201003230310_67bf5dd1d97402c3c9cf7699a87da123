package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_896:RoomCreateViewCtrl;
      
      private var var_2178:RoomThumbnailRenderer;
      
      private var var_183:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_612:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_431:Tabs;
      
      private var var_282:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_282 = new MainViewCtrl(this);
         var_612 = new RoomInfoViewCtrl(this);
         var_896 = new RoomCreateViewCtrl(this);
         var_2178 = new RoomThumbnailRenderer(this);
         var_954 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_431 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_282.startSearch(Tabs.const_195,Tabs.const_297,param1);
         var_282.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_183 != null)
         {
            var_183.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_895)
         {
            var_895.release(new IIDSessionDataManager());
            var_895 = null;
         }
         if(_catalog)
         {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_157.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_183 != null)
         {
            var_183.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_183.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_282.startSearch(Tabs.const_275,Tabs.const_209);
         var_431.getTab(Tabs.const_275).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_282.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
