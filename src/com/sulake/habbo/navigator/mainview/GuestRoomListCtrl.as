package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private function method_11(param1:WindowEvent, param2:IWindow) : void
      {
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1303 != null)
         {
            _loc2_ = var_1303.tags[0];
            var_1303.color = getBgColor(_loc2_);
         }
         var_1303 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_367 = IScrollbarWindow(var_19.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_2118 - _loc2_.stageX);
         var_2118 = _loc2_.stageX;
         var_2119 = _loc3_ > 2;
      }
      ...
      private function refreshFavouriteIcon(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         refreshRegion(param1,"favourite",_loc3_ && !_loc4_,method_11);
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_167,null,0);
         ...
         var_787.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.doorMode)
               {
                  case RoomSettingsFlatInfo.const_127:
                     ...
                     return;
                  case RoomSettingsFlatInfo.const_167:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1339,true);
