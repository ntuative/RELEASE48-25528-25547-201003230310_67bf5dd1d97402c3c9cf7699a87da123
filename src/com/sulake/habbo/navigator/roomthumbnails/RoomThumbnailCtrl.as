package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this._model.mode != ThumbnailEditorModel.const_38);
         setEnabled(var_1445,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1446,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_38;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1445 = IButtonWindow(find("top_tab"));
         var_1446 = IButtonWindow(find("obj_tab"));
         var_1798 = IWindowContainer(find("tile_grid"));
         var_1797 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1445,onTopTabButton);
         Util.setProcDirectly(var_1446,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1798;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_417)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1797;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_57,HabboWindowStyle.const_40,HabboWindowParam.const_66,new Rectangle(0,0,param1.width,66)));
      ...
      {
         refreshImgSelector(ThumbnailEditorModel.const_38);
