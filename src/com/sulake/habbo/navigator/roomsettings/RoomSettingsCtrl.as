package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1129:IWindowContainer;
      ...
      private var var_1127:ICheckBoxWindow;
      ...
      private function populateForm() : void
      {
         ...
         var_1132.setText(_loc1_.description);
         var_954.setText("");
         var_1126.setText("");
         ...
         setTag(var_806,_loc1_.tags[1]);
         if(var_1130)
         {
            if(_loc1_.allowPets)
            {
               this.var_1130.select();
            }
            else
            {
               this.var_1130.unselect();
            }
         }
         if(var_1131)
         {
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_375);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_79.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_375]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_245.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_245.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_245.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_245.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_245.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_245.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_245.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_245);
         var_245.findChildByName("ruler").visible = true;
         ...
         if(var_79.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_245,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_57,HabboWindowStyle.const_40,HabboWindowParam.const_66,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1398.visible = _inRoom;
         var_1399.visible = _inRoom;
         var_1640.visible = var_456;
         var_1641.visible = !var_456;
         if(var_456)
         {
         ...
         {
            populateForm();
            var_956.visible = true;
            var_1128.visible = true;
            var_1129.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1129.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_956.height = Util.getLowestPoint(this.var_956) + 4;
         }
         var_1396.text = !!var_456 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1398.name,var_1129.name,var_956.name,var_955.name,var_1128.name,var_1399.name],0,0);
      ...
      {
         this.var_375 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_375));
         if(var_952 != null)
         {
            var_952.visible = false;
         }
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1132.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_438;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_127)
         {
            _loc8_ = var_954.getText();
         ...
         var _loc6_:FlatCategory = getFlatCategoryByIndex(var_79.categoryId,_loc5_.selection);
         _loc2_.categoryId = _loc6_.nodeId;
         var _loc7_:IDropMenuWindow = _window.findChildByName("maxvisitors") as IDropMenuWindow;
         _loc2_.maximumVisitors = 10 + _loc7_.selection * 5;
         _loc2_.allowPets = var_1130.isSelected;
         _loc2_.allowFoodConsume = var_1131.isSelected;
         _loc2_.allowWalkThrough = var_1127.isSelected;
         _loc2_.tags = new Array();
         addTag(var_807,_loc2_.tags);
         addTag(var_806,_loc2_.tags);
         this.clearErrors();
         this.var_953 = _loc2_.roomId;
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_375));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_375 || var_953 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_1132.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1194)
         {
            ...
            setTagError(this.var_806,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1351)
         {
            ...
            setTagError(this.var_806,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_738,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_916,onDoorModePasswordUnselect);
         ...
         this.var_1132 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_807 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_806 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_954 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1126 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1130 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1131 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1127 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1398 = IWindowContainer(_window.findChildByName("header_container"));
         var_1129 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_956 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_955 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1399 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1128 = IWindowContainer(_window.findChildByName("footer_container"));
         var_245 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_952 = IWindowContainer(_window.findChildByName("password_container"));
         var_1641 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1640 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1396 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1396.procedure = onSwitchView;
         var_952.visible = false;
         if(!_inRoom)
         {
