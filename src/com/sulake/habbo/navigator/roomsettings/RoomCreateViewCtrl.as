package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_767:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_455 = new Timer(100);
         var_455.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,104,"a"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,94,"b"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,36,"c"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,84,"d"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,80,"e"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,80,"f"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_134,80,"g"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_134,74,"h"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,416,"i"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,320,"j"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,448,"k"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,352,"l"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,384,"m"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_76,372,"n"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_134,416,"o"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_134,352,"p"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_134,304,"q"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_134,336,"r"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_150,0,"s"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_150,0,"t"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_150,0,"u"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_150,0,"v"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_150,0,"w"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_150,0,"x"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_951 = new TextFieldManager(_navigator,ITextFieldWindow(var_19.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         if(param2.requiredClubLevel == HabboClubLevelEnum.const_134)
         {
            _loc8_ = "hc_only";
         }
         if(param2.requiredClubLevel == HabboClubLevelEnum.const_150)
         {
            _loc8_ = "vip_icon";
         }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_951.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1633 = _navigator.data.hcMember;
      }
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         ...
         {
            case HabboClubLevelEnum.const_76:
               return true;
            case HabboClubLevelEnum.const_134:
               return _navigator.sessionData.hasUserRight("fuse_use_special_room_layouts");
            case HabboClubLevelEnum.const_150:
      ...
      public function dispose() : void
      {
         if(var_455)
         {
            var_455.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_455.reset();
            var_455 = null;
         }
      }
      ...
      {
         var_951.goBackToInitialState();
         var_951.input.textBackgroundColor = 4294967295;
         var_767 = var_40[0];
         if(var_1633 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_40,HabboWindowParam.const_66,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_951.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_767.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1125 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1125 = true;
            _loc3_.y = 1;
