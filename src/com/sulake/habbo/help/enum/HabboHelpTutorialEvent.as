package com.sulake.habbo.help.enum
{
   ...
   public class HabboHelpTutorialEvent extends Event
   {
      ...
      public static const const_578:String = "HHTPNUFWE_DONE_GUIDEBOT";
      
      public static const const_526:String = "HHTE_DONE_AVATAR_EDITOR_CLOSING";
      
      public static const const_100:String = "HHTPNUFWE_AVATAR_TUTORIAL_START";
      
      public static const const_403:String = "HHTPNUFWE_LIGHT_CLOTHES_ICON";
      
      public static const const_570:String = "HHTE_DONE_AVATAR_EDITOR_OPENING";
