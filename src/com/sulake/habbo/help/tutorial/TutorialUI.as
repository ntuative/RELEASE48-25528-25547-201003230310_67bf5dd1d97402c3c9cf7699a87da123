package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_258:String = "TUI_NAME_VIEW";
      
      public static const const_85:String = "TUI_MAIN_VIEW";
      
      public static const const_290:String = "TUI_CLOTHES_VIEW";
      
      public static const const_443:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_578,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_570,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_526,onTaskDoneEvent);
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1015 = param2;
         var_1014 = param3;
         if(var_36 == null || var_36.id == const_85)
         {
            prepareForTutorial();
            showView(const_85);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1015 = true;
         if(var_36 != null && (var_36.id == const_258 || var_36.id == const_85))
         {
            showView(const_85);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1401;
         _window.width = _loc2_.width + var_1400;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_578:
               var_1014 = true;
               if(var_36 != null && var_36.id == const_443)
               {
                  showView(const_85);
               }
               break;
            case HabboHelpTutorialEvent.const_570:
               if(var_36 != null && var_36.id == const_290)
               {
                  var_1223 = true;
                  disposeWindow();
               }
      ...
      {
         var_1013 = true;
         if(var_36 != null && (var_36.id == const_290 || var_36.id == const_85))
         {
            showView(const_85);
         }
      }
      ...
      {
         return var_1013 && var_1015 && var_1014;
      }
   }
}
