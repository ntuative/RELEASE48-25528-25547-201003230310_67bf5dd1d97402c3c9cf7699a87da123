package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1039:int = 0;
      
      private static const const_340:int = 1;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_640 == null || _loc3_ < 0 || _loc3_ >= var_640.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_640[_loc3_];
            main.showUI(HabboHelpViewEnum.const_676);
            main.tellUI(HabboHelpViewEnum.const_676,null);
         }
      }
   }
}
