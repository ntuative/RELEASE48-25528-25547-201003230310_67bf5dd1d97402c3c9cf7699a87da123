package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1644:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25528-25547-201003230240");
         var_183 = param5;
         var_96 = new Map();
         var_96.add(HabboHelpViewEnum.const_1227,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_141,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_359,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_257,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_197,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_638,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_285,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_676,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_228,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_96.add(HabboHelpViewEnum.const_891,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_591,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1400 = 0 - _loc3_.width;
         var_1401 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_246 == HabboHelpViewEnum.const_141 || false)
         {
            return;
         }
         if(var_377 == null)
         {
            ...
            var_377 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_377 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_377 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_377 as IWindow);
      ...
      {
         return var_96.getValue(var_246);
      }
      ...
      {
         var_1643 = param1;
         var _loc2_:IHelpViewController = var_96.getValue(HabboHelpViewEnum.const_141) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_228:
               ...
               break;
            case CallForHelpResultEnum.const_943:
               showUI(HabboHelpViewEnum.const_891);
               break;
            case CallForHelpResultEnum.const_1002:
      ...
      {
         var _loc3_:* = null;
         if(var_246 == HabboHelpViewEnum.const_141)
         {
            return;
         }
         if(true)
         {
            ...
            var_544.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_544.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_377.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_544[1],var_544[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_544[0],var_544[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1401;
         _window.width = _loc1_.width + var_1400;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_246);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_183 != null)
            {
               var_183.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_578));
      }
