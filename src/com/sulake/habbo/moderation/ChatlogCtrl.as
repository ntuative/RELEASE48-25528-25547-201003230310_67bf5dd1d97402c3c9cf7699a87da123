package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1480:IMessageComposer;
      ...
      {
         var_877 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_876 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         var_407 = new Timer(300,1);
         var_407.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_50 = IFrameWindow(_main.getXmlWindow("chatlog_frame"));
         var_48 = IItemListWindow(var_50.findChildByName("chatline_list"));
         var_50.procedure = onWindow;
         var _loc1_:IWindow = var_50.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1480);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_877.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_50,_main,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         if(param1.type != WindowEvent.const_44 || param2 != var_50)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_876.clone());
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_50,_main,_loc6_,param2.chatterId);
         }
