package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1046:ICheckBoxWindow;
      ...
      private var var_715:ICheckBoxWindow;
      
      private var var_50:IFrameWindow;
      
      private var var_1047:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_537,_data.flatId),var_50,false,false,true);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new UserInfoFrameCtrl(_main,_data.ownerId),var_50,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_715.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1259,_loc2_,var_395.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1046.isSelected,var_1047.isSelected,var_715.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1361);
      }
      
      public function populate() : void
      {
         var_48 = IItemListWindow(var_50.findChildByName("list_cont"));
         ...
         var_715 = ICheckBoxWindow(var_50.findChildByName("kick_check"));
         var_1046 = ICheckBoxWindow(var_50.findChildByName("lock_check"));
         var_1047 = ICheckBoxWindow(var_50.findChildByName("changename_check"));
         ...
         _main.disableButton(_main.initMsg.bobbaFilterPermission,var_50,"bobba_filter_but");
      ...
      {
         var_50 = IFrameWindow(_main.getXmlWindow("roomtool_frame"));
         _main.messageHandler.addRoomInfoListener(this);
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_375));
