package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1523:IIssueBrowserView;
      
      private const const_1647:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1649:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1521:IIssueBrowserView;
      
      private const const_1658:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1648:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_226:ITabContextWindow;
      
      private var var_1522:PickedIssuesView;
      
      private var var_347:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_347.view.width = var_226.container.width;
         var_347.view.height = var_226.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1648:
               if(var_1521 == null)
               {
                  var_1521 = new MyIssuesView(issueManager,this,var_226.container);
               }
               return var_1521;
            case const_1647:
               if(var_1523 == null)
               {
                  var_1523 = new OpenIssuesView(issueManager,this,var_226.container);
               }
               return var_1523;
            case const_1649:
               if(var_1522 == null)
               {
                  var_1522 = new PickedIssuesView(issueManager,this,var_226.container);
               }
               return var_1522;
            default:
               return null;
