package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_439:UserInfoCtrl;
      
      private var var_58:ModerationManager;
      
      private var var_1077:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_439 = new UserInfoCtrl(_window,var_58,_loc3_.message);
         var_1077 = new UserInfoCtrl(_window,var_58,_loc3_.message);
         var_439.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_112.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1077.load(_loc4_,var_112.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_58.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_58,WindowTracker.const_931,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_439 = new UserInfoCtrl(_window,var_58,_loc3_.message);
            var_439.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
