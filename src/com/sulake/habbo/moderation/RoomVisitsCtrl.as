package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2095.clone());
         ...
         new OpenRoomTool(var_50,_main,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_2095 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_50 = IFrameWindow(_main.getXmlWindow("roomvisits_frame"));
         var_48 = IItemListWindow(var_50.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1172;
      }
   }
}
