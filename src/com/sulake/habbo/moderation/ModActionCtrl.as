package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_804:IButtonWindow;
      
      private var var_1194:int;
      
      private var _main:ModerationManager;
      
      private var var_669:OffenceCategoryData;
      ...
      private var var_670:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_804 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_803 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_802.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1194,var_395.text,getBanLength(),var_1193));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_802.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1194,var_395.text,var_1193));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_669 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1194,var_395.text,var_1193));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_669 != null;
         if(this.var_670 != null)
         {
            var_50.findChildByName("offence_txt").caption = this.var_670.name;
            var_50.findChildByName("offence_category").visible = true;
         }
         else if(this.var_669 != null)
         {
            this.refreshButtons("offences_cont",2,var_669.offences,var_804,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_803,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_670 = var_669.offences[_loc3_];
         var_395.text = var_670.msg;
         var_300 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_50.caption = "Mod action on: " + var_1455;
         ...
         var_802 = IDropMenuWindow(var_50.findChildByName("banLengthSelect"));
         prepareBanSelect(var_802);
