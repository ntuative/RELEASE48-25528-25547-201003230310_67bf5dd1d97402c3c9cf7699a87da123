package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1617 = param2;
         var_332 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_120,onBadgeImageReady);
         ...
         var_1653 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_332 != null)
         {
            var_332.events.removeEventListener(BadgeImageReadyEvent.const_120,onBadgeImageReady);
            var_332 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_645,var_1653);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_645,var_645));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_645,var_645));
         _localizations.registerParameter(param1,"level",var_1617.toString());
         _localizations.registerParameter(param1,"name",var_332.userName);
         _localizations.registerParameter(param1,"realname",var_332.realName);
      }
   }
}
