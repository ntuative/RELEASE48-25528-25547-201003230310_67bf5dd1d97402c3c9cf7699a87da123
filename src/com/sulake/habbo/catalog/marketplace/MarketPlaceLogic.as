package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2154:MarketplaceItemStats;
      ...
      private var var_201:MarketplaceConfirmationDialog;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1473,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1912 || param1.furniTypeId != var_1911)
         {
            return;
         }
         var_2154 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_204.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_204.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_204.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_477)
            {
               var_204.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1895 = _loc3_.creditsWaiting;
         var_204 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_204.add(_loc4_.offerId,_loc6_);
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_201)
         {
            var_201 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_201.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2155,var_2153,var_1768,var_2152);
      }
