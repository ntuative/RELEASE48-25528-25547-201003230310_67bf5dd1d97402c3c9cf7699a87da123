package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1341:IScrollbarWindow;
      
      protected var var_1356:XML;
      
      private var var_1340:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_613 != null)
         {
            var_613.visible = false;
            var_613.destroyGridItems();
         }
         if(var_1341 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1173.text = "${" + _loc3_.name + "}";
            var_1172.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1173.text = "${" + _loc2_.localizationId + "}";
            var_1172.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            {
               case Offer.const_351:
                  _loc4_ = var_1340.clone();
                  if(var_613 != null)
                  {
                     var_613.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_613,var_1341,var_1356);
                  }
                  break;
               ...
               case Offer.const_441:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_218:
                        ...
                        _loc4_ = new BitmapData(var_85.width,var_85.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_310,AvatarAction.const_601);
                              _loc13_.appendAction(AvatarAction.const_501,_loc6_.productClassId);
      ...
      {
         var_1173 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1172 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1570 = new Point(var_85.x,var_85.y);
         var_613 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1341 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_613 == null)
         {
         ...
         var_1340 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_85);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_85 != null && true)
         {
            ...
            if(true)
            {
               var_85.bitmap = new BitmapData(var_85.width,var_85.height,true,16777215);
            }
            var_85.bitmap.fillRect(var_85.bitmap.rect,16777215);
            _loc4_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_85.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_85.invalidate();
            var_85.x = var_1570.x;
            var_85.y = var_1570.y;
            if(param3 != null)
