package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_416.getWithIndex(var_200);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(var_85 != null)
         {
            ...
            var_85.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
            var_85.invalidate();
         }
      ...
      override public function init() : void
      {
         ...
         var _loc8_:* = null;
         super.init();
         var_85 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_416.getValue(_loc6_) == null)
            {
               var_416.add(_loc6_,new Map());
            }
            _loc8_ = var_416.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_416.getWithIndex(var_200);
         if(_loc4_ != null)
         {
