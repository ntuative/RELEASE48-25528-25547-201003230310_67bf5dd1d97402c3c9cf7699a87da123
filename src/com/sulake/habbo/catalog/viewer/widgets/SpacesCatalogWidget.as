package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1221:String = "default";
      
      private var var_1306:Array;
      
      private var var_278:BitmapData = null;
      
      private var var_232:int = 0;
      
      private var var_728:int = 0;
      
      private var var_1219:String = "1.1";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_157.floors.pattern)
                     {
                        _activeFloorPatterns.push(String(_loc9_.@id));
                        var_1306.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_157.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_157.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_278 != null && var_277 != null)
         {
            setRoomImage(var_278,var_277);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_157.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_232 >= 0)
         ...
         for each(_loc1_ in var_157.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
         ...
         for each(_loc1_ in var_157.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_188:
               ...
               var_727 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_157.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_727 = _loc8_.children().length();
                  }
               }
            ...
            case const_190:
               ...
               for each(_loc9_ in var_157.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_726 = _loc9_.children().length();
                  }
               }
            ...
            case const_189:
               ...
               var_728 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_157.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_728 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1221);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1308[var_312];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1219);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1221,var_1219,64,this,"window_romantic_wide");
