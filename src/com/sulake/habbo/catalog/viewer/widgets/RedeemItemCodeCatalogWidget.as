package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1054:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1053 != null)
         {
            var_1053.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1054 != null)
         {
            var_1054.removeEventListener(WindowKeyboardEvent.const_138,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1053 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1053 != null)
         {
            var_1053.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1054 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1054 != null)
         {
            var_1054.addEventListener(WindowKeyboardEvent.const_138,windowKeyEventProcessor);
         }
      }
