package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1357:XML;
      
      private var var_293:IGridItem;
      
      private var var_1356:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_916:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_749[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_916 = new PrizeViewer();
         var_749 = recycler.getPrizeTable();
         if(var_749 == null)
         {
            return;
         }
         ...
         var_1357 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_749[0].prizes.length > 0)
         {
            select(var_749[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1357) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1356) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_916.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
