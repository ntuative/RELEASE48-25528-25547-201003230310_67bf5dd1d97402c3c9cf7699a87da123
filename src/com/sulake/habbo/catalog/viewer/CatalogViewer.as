package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1505:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_583 != null)
         {
            if(var_583.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_583.window);
            var_583.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1505);
         var_583 = _loc5_;
      ...
      {
         return var_583.dispatchWidgetEvent(param1);
      }
