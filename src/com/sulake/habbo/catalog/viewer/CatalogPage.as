package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1402:String = "ctlg_";
      ...
      private var var_1161:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_916:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1402 + param1;
      ...
      {
         return _localization.hasLinks(var_775);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1161;
            _loc2_.init();
         }
         var_1161.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1161.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_775);
      }
