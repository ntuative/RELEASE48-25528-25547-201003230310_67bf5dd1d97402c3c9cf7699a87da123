package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1050:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1422:XML;
      
      private static var var_1423:XML;
       
      
      private var var_2293:IWindowContainer;
      ...
      private var var_1421:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1421 == 4294967295)
            {
               var_1421 = _loc1_.color;
            }
            _loc1_.color = const_1050;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1305;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1422) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_48 = navigator.catalog.windowManager.buildFromXML(var_1423) as IItemListWindow;
         if(var_48 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1220;
            }
         }
      }
