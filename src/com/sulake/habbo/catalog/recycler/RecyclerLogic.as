package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_765:int = 0;
      
      public static const const_152:int = 5;
      
      private static const const_344:int = 1;
      
      private static const const_764:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1465)
         {
            case RecyclerStatusMessageEvent.const_1177:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1010:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1465 != RecyclerStatusMessageEvent.const_1010;
      }
      
      private function get statusActive() : Boolean
      {
         return var_254 != const_765;
      }
      ...
      {
         return active && var_254 == const_344;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_152)
            {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_895:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1273:
