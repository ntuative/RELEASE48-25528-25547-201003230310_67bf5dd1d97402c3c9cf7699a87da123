package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_201:PurchaseConfirmationDialog;
      ...
      private var var_417:ICatalogNavigator;
      ...
      private var var_2084:GiftWrappingConfiguration;
      ...
      private var var_1042:ClubGiftController;
      ...
      {
         return var_332.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2085 && var_497 != null)
         {
            var_497.playSound(HabboSoundTypesEnum.const_831);
         }
         var_2085 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_332.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_80)
         {
            _loc3_ = var_332.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_201.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_97:
               var_1290 = param1.session.isPrivateRoom;
               if(var_83 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_157.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_157.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2084 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_183.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_205,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1042.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_417 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_1042 == null)
         {
            var_1042 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_201 == null)
            {
               var_201 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_201.showOffer(this,param1,param2,param3,_loc7_);
      ...
      {
         var_183.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new MarketplaceBuyOfferResultEvent(method_10));
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_417.buildCatalogIndex(_loc2_);
         if(var_1043 != "")
         {
            var_417.openPage(var_1043);
            var_1043 = "";
         }
         else
         {
            var_417.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_164)
         {
            _loc3_ = var_157.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2086 && var_497 != null)
         {
            var_497.playSound(HabboSoundTypesEnum.const_971);
         }
         var_2086 = false;
      }
      ...
      private function method_10(param1:IMessageEvent) : void
      {
         if(var_110 != null)
         {
