package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1417:uint = 4.294967295E9;
      
      private const const_1416:uint = 4.293848814E9;
      
      private var var_904:int;
      
      private const const_1655:uint = 4.291613146E9;
      
      private var var_283:int = -1;
      ...
      private const const_1656:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_234.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_903;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_903,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1416) : uint(const_1417);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_583,var_76,var_1073);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_234.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_283) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_903);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_614[var_206]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_615[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_583,var_76,var_1073,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_49:
               ...
               break;
            case WindowKeyboardEvent.const_600:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_283 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_283 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1571 = _loc1_.stuffTypes;
            var_614 = _loc1_.boxTypes;
            var_615 = _loc1_.ribbonTypes;
            var_903 = var_1571[0];
            var_206 = var_614[0];
            _ribbonIndex = var_615[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_234.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_283) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_283);
         }
         var_283 = param1;
         if(var_283 < 0)
         {
            var_283 = _loc2_.numListItems - 1;
         }
         if(var_283 >= _loc2_.numListItems)
         {
            var_283 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_283) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_234 == null)
         {
            var_234 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_518 == null)
         {
            var_518 = createWindow("suggestion_list_item") as IWindowContainer;
            var_518.procedure = suggestionsEventHandler;
         }
         if(var_234 == null || var_518 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_234.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_518.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
