package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_848:ConversationsTabView;
      
      private var _disposed:Boolean = false;
      
      private var var_139:HabboMessenger;
      
      private var var_1272:ConversationView;
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.var_1272.afterResize();
         this.var_848.refresh();
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_701.text = "";
         var_139.conversations.addMessageAndUpdateView(new Message(Message.const_555,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_13 == null)
         {
            prepareContent();
            refresh(true);
            var_139.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MESSENGER,var_13));
         }
         else
         {
            refresh(true);
      ...
      {
         return this.var_848 == null ? 7 : int(this.var_848.getTabCount());
      }
      ...
      private function prepareContent() : void
      {
         ...
         var_848 = new ConversationsTabView(var_139,var_13);
         var_848.refresh();
         var_701 = ITextFieldWindow(var_13.findChildByName("message_input"));
         var_701.addEventListener(WindowKeyboardEvent.const_138,onMessageInput);
         var_1272 = new ConversationView(var_139,var_13);
         var_13.scaler.setParamFlag(HabboWindowParam.const_556,false);
         var_13.scaler.setParamFlag(HabboWindowParam.const_977,true);
      }
   }
}
