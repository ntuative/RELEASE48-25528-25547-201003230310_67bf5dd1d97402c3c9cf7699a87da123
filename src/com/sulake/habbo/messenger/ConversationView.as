package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1128:int = 10;
      
      private static const const_1127:int = 20;
      
      private static const const_791:int = 100;
      ...
      private var var_1573:IContainerButtonWindow;
      
      private var var_519:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_139 = param1;
         var_1573 = initButton("follow_friend",onFollowButtonClick,param2);
         var_48 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2196 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      {
         if(param1 == Message.const_512)
         {
            return 4285887861;
         }
         if(param1 == Message.const_693)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_555 || param3.type == Message.const_644 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_519.messages.length - const_791);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_519.messages.length)
         {
            refreshEntry(true,_loc1_,var_519.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_519 == null || _loc1_.id != var_519.id)
         {
            var_519 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_791 + const_1127)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_139.send(new FollowFriendMessageComposer(var_519.id));
      }
      ...
      {
         if(param1 == Message.const_555)
         {
            return 4294967295;
         }
         if(param1 == Message.const_644)
         {
            return 4292801535;
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1128;
         param1.invalidate();
      }
   }
}
