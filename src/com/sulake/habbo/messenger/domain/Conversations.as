package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1178:int = 1;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         var _loc3_:Conversation = method_4(param1);
         if(_loc3_ == null)
         {
            return null;
         }
         if(false)
         {
            var_123[0].setSelected(true);
         }
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_512,0,var_387.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      
      private function method_4(param1:int) : Conversation
      {
         ...
         _loc2_ = var_387.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_387.getTabCount());
      ...
      {
         return var_387.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function closeConversation() : void
      {
         ...
         var _loc2_:int = var_123.indexOf(_loc1_);
         Util.remove(var_123,_loc1_);
         ...
         while(_loc2_ >= 0)
         {
            if(false)
            {
               var_123[_loc2_].setSelected(true);
               break;
            }
            _loc2_--;
         }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         var _loc2_:int = var_123.indexOf(param1);
         while(_startIndex + var_387.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_387.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_693,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function setFollowingAllowedAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         if(_loc3_.selected)
         {
            var_387.refresh(false);
         }
      }
      
      public function addTestUser() : void
      {
         this.addConversation(var_1178++);
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_387.addMsgToView(_loc3_,param1);
         if(_loc2_ != var_123.length || _loc4_ != _loc3_.newMessageArrived)
         {
            var_387.refresh(false);
         }
      }
