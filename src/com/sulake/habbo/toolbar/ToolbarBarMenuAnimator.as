package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1114:Number = 90;
      
      private static const const_768:int = 50;
      
      private static const const_1087:Number = 25;
      
      private static const const_1086:int = 50;
      
      private static const const_187:Boolean = true;
       
      
      private var var_579:Timer;
      
      private var var_1011:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1011 = param2;
         var_579 = new Timer(const_1087);
         var_579.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_475.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_475.splice(_loc3_,1);
            var_474.splice(_loc3_,1);
         }
         var_474.push(param1.name);
         var_475.push(param2);
         param1.addEventListener(WindowEvent.const_424,windowEventListener);
         param1.addEventListener(WindowEvent.const_230,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_475[var_474.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1011.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1011.getIconLoc(param1.iconId);
      ...
      {
         return var_474[var_475.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_580[_loc3_] = new Array();
            }
            if(var_580[_loc3_].indexOf(param1) < 0)
            {
               var_580[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_768 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_768 || param1.desktop.height - param1.y < const_1086;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_474[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_580[_loc3_].length)
                  {
                     repositionWindow(var_580[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
