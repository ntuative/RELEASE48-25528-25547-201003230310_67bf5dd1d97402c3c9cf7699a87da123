package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_315.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_864,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_464,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_616,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1017,onHideWindowEvent);
         var_32 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_87));
      }
