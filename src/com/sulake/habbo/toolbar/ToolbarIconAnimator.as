package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1115 = param1.loop;
         if(param1.background != null)
         {
            var_763 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_762.push(new XML());
               var_764.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_764[var_50] = param6.clone();
         }
      ...
      {
         if(var_1115 == true || var_635 == 0)
         {
            if(false)
            {
               ++var_50;
               if(var_50 >= var_762.length)
               {
                  var_50 = 0;
                  ++var_635;
               }
      ...
      {
         return var_762.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1115 == false && var_635 == 1 && var_1116 != var_32;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_763 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_763.width),Math.max(param2.height,var_763.height));
            _loc3_.copyPixels(var_763,var_763.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_50 <= var_764.length)
         {
            _loc2_ = var_764[var_50];
