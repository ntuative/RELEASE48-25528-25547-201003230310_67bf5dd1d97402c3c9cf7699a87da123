package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_183:IHabboToolbar = null;
      ...
      private var var_332:ISessionDataManager = null;
      
      private var var_1620:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_320,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_366,onRoomContentLoaded);
      ...
      {
         var_183 = param1;
         var_183.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         ...
         {
            var_638 = _roomEngine.loadRoomResources(var_35.roomResources);
            if(false)
            {
               var_1119 = false;
         ...
         if(var_274 != null && true)
         {
            var_1118 = !var_274.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_35.roomId,var_35.roomCategory,var_244[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_182 != null)
         {
            ...
            {
               _loc5_ = var_182.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_250,processEvent);
         }
         _friendList = null;
         var_163.dispose();
         var_163 = null;
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_320,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_366,onRoomContentLoaded);
         ...
         if(var_183 && false)
         {
            var_183.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            var_183.events.removeEventListener(HabboToolbarEvent.const_56,onHabboToolbarEvent);
         }
         var_183 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1620);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_182.length)
         {
            _loc2_ = var_182.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_183 != null)
         {
            var_163.toolbarSize = var_183.size;
            var_163.toolbarOrientation = var_183.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_244[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_661:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_331,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_725 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
                  _loc7_ = var_35.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_394)
                  {
                     var_725.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_240:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_465:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_192,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_182.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_549);
            _loc13_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_545);
            _loc14_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_613);
            _loc15_ = _roomEngine.getRoomNumberValue(var_35.roomId,var_35.roomCategory,RoomVariableEnum.const_660);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_276,canvasMouseHandler);
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_35 != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  {
                     _loc3_.iconState = "2";
                     var_183.events.dispatchEvent(_loc3_);
                  }
                  else
                  {
                     _loc3_.iconState = "0";
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_355:
               ...
               var_164 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_284,WindowStyle.const_312,WindowParam.const_83) as IToolTipWindow;
               var_164.setParamFlag(WindowParam.const_50,false);
      ...
      {
         if(var_638 == null || false)
         {
            return;
         }
         var _loc2_:int = var_638.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_638.splice(_loc2_,1);
         }
         if(false)
         {
            var_1119 = true;
      ...
      {
         if(var_18 != null && var_35 != null && var_1118 && var_1119)
         {
            var_18.startSession(var_35);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_252));
         }
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_250,processEvent);
         }
      }
