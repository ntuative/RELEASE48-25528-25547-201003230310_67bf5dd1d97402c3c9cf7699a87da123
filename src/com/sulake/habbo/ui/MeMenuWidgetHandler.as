   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_183 + " " + _loc6_);
            if(var_183 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_864,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_183.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_667,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_403,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_667,onFigureUpdate);
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_828,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_875,onHabboClubSubscriptionChanged);
         }
         var_183 = _container.toolbar;
         if(var_183)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_403,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_100:
               ...
               break;
            case HabboHelpTutorialEvent.const_403:
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_576);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_588);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_534);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_711);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_734);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_717);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_577);
         _loc1_.push(RoomWidgetStopEffectMessage.const_681);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1277);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_799);
         _loc1_.push(RoomWidgetToolbarMessage.const_562);
         _loc1_.push(RoomWidgetToolbarMessage.const_557);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_589);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1201);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_800);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_688);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_653);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_581);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1274);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_561);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_535);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_710);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_552));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_653:
               if(_container != null && false && _container.toolbar.events != null)
               {
                  _loc7_ = new HabboToolbarEvent(HabboToolbarEvent.const_56);
            ...
            case RoomWidgetWaveMessage.const_695:
               ...
               break;
            case RoomWidgetDanceMessage.const_576:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_588:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_534:
               if(var_10 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_711:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_577:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_881)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_266,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_717:
               ...
               if(var_10 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_991:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_844:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_734:
            case RoomWidgetStopEffectMessage.const_681:
            ...
            case RoomWidgetNavigateToRoomMessage.const_799:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_688:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_562:
               ...
               if(var_183)
               {
                  var_183.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_557:
               ...
               if(var_183 && false)
               {
                  var_183.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_464,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_589:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_570));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_581:
            ...
            case RoomWidgetStoreSettingsMessage.const_561:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_308,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_535:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_308,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_710:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_526));
               }
               break;
            default:
