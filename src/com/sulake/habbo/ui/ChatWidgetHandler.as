package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_517:Point = null;
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(var_741.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_301:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_92);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_92);
                                       if(_loc16_ != null)
                                       {
      ...
      {
         return [RoomWidgetChatMessage.const_682,RoomWidgetChatSelectAvatarMessage.const_500];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_682:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_144,_container.roomSession,0,"Version 25528-25547-201003230240");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_500:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_898 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_898);
            }
            if(var_517 == null)
            {
               var_516.x = 0;
               var_516.y = 0;
               var_516.z = 0;
               var_517 = _loc4_.getScreenPoint(var_516);
               var_898 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_516.x = 0;
            var_516.y = 0;
            var_516.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_516);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_517.x || _loc8_.y != var_517.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_517,_loc5_));
