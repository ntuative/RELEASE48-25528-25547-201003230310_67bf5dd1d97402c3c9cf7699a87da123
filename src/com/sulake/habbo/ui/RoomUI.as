package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_497:IHabboSoundManager;
      
      private var var_1304:IHabboAvatarEditor = null;
      ...
      private var var_725:IHabboModeration;
      
      private var var_332:ISessionDataManager;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.sessionDataManager = var_332;
         _loc3_.roomSessionManager = var_18;
         _loc3_.friendList = _friendList;
         _loc3_.avatarRenderManager = var_556;
         _loc3_.inventory = var_10;
         _loc3_.toolbar = var_183;
         _loc3_.navigator = _navigator;
         _loc3_.avatarEditor = var_1304;
         _loc3_.catalog = _catalog;
         _loc3_.adManager = var_274;
         _loc3_.localization = _localization;
         _loc3_.habboHelp = var_882;
         _loc3_.moderation = var_725;
         _loc3_.config = _config;
         _loc3_.soundManager = var_497;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_497 = param2 as IHabboSoundManager;
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_335:
            ...
            case RoomSessionEvent.const_104:
               if(param1.session != null)
               {
                  ...
                  var_183.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_161,HabboToolbarIconEnum.ZOOM));
                  var_183.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_161,HabboToolbarIconEnum.MEMENU));
                  var_183.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_161,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_274.events.addEventListener(AdEvent.const_456,adEventHandler);
            var_274.events.addEventListener(AdEvent.const_387,adEventHandler);
      ...
      override public function dispose() : void
      {
         ...
         if(var_497 != null)
         {
            var_497.release(new IIDHabboSoundManager());
            var_497 = null;
         }
         if(var_274 != null)
         {
         ...
         if(var_556 != null)
         {
            var_556.release(new IIDAvatarRenderManager());
            var_556 = null;
         }
         if(_catalog != null)
         {
         ...
         if(var_725 != null)
         {
            var_725.release(new IIDHabboModeration());
            var_725 = null;
         }
         if(_navigator != null)
         {
         ...
         if(var_332 != null)
         {
            var_332.release(new IIDSessionDataManager());
            var_332 = null;
         }
         var_1304 = null;
         _connection = null;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_245);
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_725 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_725);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_332 = param2 as ISessionDataManager;
      }
            ...
            case RoomEngineEvent.const_585:
               ...
               if(_roomEngine != null)
               {
                  ...
                  if(!_roomEngine.isPublicRoomWorldType(_roomEngine.getWorldType(param1.roomId,param1.roomCategory)))
                  {
                     ...
                     _loc7_.iconState = "2";
                     var_183.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_245);
               if(var_1557 != RoomDesktop.const_612)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_245,var_1557);
               }
               if(var_274 != null)
               {
                  var_274.showRoomAd();
               ...
               break;
            case RoomEngineEvent.const_698:
               disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_567:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_225:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_153:
            ...
            case RoomSessionErrorMessageEvent.const_611:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_548:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_509,roomEngineEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_585,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_698,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_64,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_567,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_661,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_465,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_240,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_666,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_226,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_587,roomObjectEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_556 = param2 as IAvatarRenderManager;
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_183 = param2 as IHabboToolbar;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            var_18.events.addEventListener(RoomSessionEvent.const_335,roomSessionStateEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionChatEvent.const_144,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionUserBadgesEvent.const_113,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_99,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionPresentEvent.const_241,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_938,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_927,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_611,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_548,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_153,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_657,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_620,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionQueueEvent.const_404,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionPollEvent.const_108,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPollEvent.const_59,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPollEvent.const_116,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_381,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionFriendRequestEvent.const_128,roomSessionEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_509)
         {
            if(var_18 != null)
            {
               var_18.roomEngineReady = true;
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1304 = param2 as IHabboAvatarEditor;
      }
   }
}
