   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_139,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_120,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_136,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_148,onPetInfo);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetCommandsUpdateEvent.const_143,onPetCommands);
            }
         }
         _container = param1;
         if(param1 == null)
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_139,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_120,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_136,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_148,onPetInfo);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetCommandsUpdateEvent.const_143,onPetCommands);
         }
      }
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_586);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_313);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1003);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_826);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_301)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_394)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_858)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_640);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_217)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_646);
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1019;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1400);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_582.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_51);
            var_582.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_646);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_113];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_292);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_396);
         _loc1_.push(RoomWidgetUserActionMessage.const_731);
         _loc1_.push(RoomWidgetUserActionMessage.const_584);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_246);
         _loc1_.push(RoomWidgetFurniActionMessage.const_554);
         _loc1_.push(RoomWidgetFurniActionMessage.const_702);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_669);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1266);
         _loc1_.push(RoomWidgetPetCommandMessage.const_639);
         _loc1_.push(RoomWidgetPetCommandMessage.const_741);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_113:
      ...
      public function dispose() : void
      {
         ...
         if(var_582 != null)
         {
            _loc1_ = var_582.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_582.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_479)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_292:
            ...
            case RoomWidgetUserActionMessage.const_517:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_848,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_649:
               ...
               break;
            case RoomWidgetUserActionMessage.const_396:
            ...
            case RoomWidgetUserActionMessage.const_731:
               ...
               break;
            case RoomWidgetUserActionMessage.const_584:
            ...
            case RoomWidgetUserActionMessage.const_468:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_669:
