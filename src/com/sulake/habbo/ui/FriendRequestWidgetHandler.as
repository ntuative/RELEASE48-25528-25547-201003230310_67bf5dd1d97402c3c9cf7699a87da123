package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_625);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_656);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_128:
            ...
            case FriendRequestEvent.const_250:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_625:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_656:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_128);
         _loc1_.push(FriendRequestEvent.const_52);
         _loc1_.push(FriendRequestEvent.const_250);
         return _loc1_;
      }
