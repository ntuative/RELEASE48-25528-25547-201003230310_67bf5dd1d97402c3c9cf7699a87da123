package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1412:String = "noconvinfo";
      ...
      private var var_1144:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1144 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_900 = IWindowContainer(var_13.content.findChildByName("main_content"));
         var_258 = IWindowContainer(var_13.content.findChildByName("footer"));
         var_1144.prepare(var_900);
         var_13.procedure = onWindow;
         var_13.content.setParamFlag(HabboWindowParam.const_830,false);
         var_13.content.setParamFlag(HabboWindowParam.const_1219,true);
         var_13.header.setParamFlag(HabboWindowParam.const_519,false);
         var_13.header.setParamFlag(HabboWindowParam.const_812,true);
         var_13.content.setParamFlag(HabboWindowParam.const_519,false);
         var_13.content.setParamFlag(HabboWindowParam.const_812,true);
         var_13.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1143 = ITextWindow(var_13.findChildByName("info_text"));
         var_1143.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_258.y = Util.getLowestPoint(var_13.content);
         var_258.width = _friendList.tabs.windowWidth;
         ...
         var_13.scaler.setParamFlag(HabboWindowParam.const_977,this._friendList.tabs.findSelectedTab() != null);
         var_13.scaler.setParamFlag(HabboWindowParam.const_519,false);
         var_13.scaler.setParamFlag(HabboWindowParam.const_830,false);
         var_13.scaler.x = 0 - var_13.scaler.width;
         var_13.scaler.y = 0 - var_13.scaler.height;
         var_1410 = var_13.height;
         var_1409 = var_13.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1410 == -1 ? 0 : int(0 - var_1410);
         var _loc4_:int = var_1409 == -1 ? 0 : int(0 - var_1409);
