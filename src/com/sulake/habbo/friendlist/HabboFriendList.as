package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_159:String = "face";
      ...
      private var var_1589:OpenedToWebPopup;
      
      private var var_915:IAvatarRenderManager;
      
      private var var_183:IHabboToolbar;
      
      private var var_431:FriendListTabs;
      ...
      private var var_1588:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_923:FriendRequests;
      
      private var var_1681:int;
      
      var var_86:FriendCategories;
      
      private var var_2234:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_924:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2234 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_86 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1588 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_923.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_923.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_431.findTab(FriendListTab.const_88).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_923 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_86.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_86.addCategory(new FriendCategory(FriendCategory.const_808,getText("friendlist.friends")));
         var_86.addCategory(new FriendCategory(FriendCategory.const_472,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_86.addFriend(new Friend(_loc4_));
         }
         var_431 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_528)
         {
            var_528 = new Timer(120000);
            var_528.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_528.start();
         }
         getBuddyRequests();
         registerListeners();
         var_183.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_528.stop();
            var_528.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_528 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_139)
         {
            var_139.release(new IIDHabboMessenger());
            var_139 = null;
         }
         if(var_157)
         {
         ...
         if(var_915)
         {
            var_915.release(new IIDAvatarRenderManager());
            var_915 = null;
         }
         if(var_924)
         {
            var_924.release(new IIDHabboNotifications());
            var_924 = null;
         }
         if(var_183)
         {
      ...
      {
         var _loc1_:String = var_157.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_431.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_334));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var_183 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1588.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_923.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_183.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:FriendListTab = var_431.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_915.createAvatarImage(param1,AvatarScaleType.const_92);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_923.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_431.findTab(FriendListTab.const_88);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_915 = param2 as IAvatarRenderManager;
      ...
      {
         var_924 = param2 as IHabboNotifications;
      ...
      {
         return var_157.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1589 == null)
         {
            var_1589 = new OpenedToWebPopup(this);
         }
         var_1589.show(x,y);
      }
