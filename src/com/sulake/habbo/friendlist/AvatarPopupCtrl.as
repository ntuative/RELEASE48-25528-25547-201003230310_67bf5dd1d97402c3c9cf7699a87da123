package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1241 != "")
         {
            friendList.refreshText(param1,"name_text_online",var_738,var_1241);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",var_738,var_1564);
         }
         friendList.refreshText(param1,"name_text_offline",!var_738,var_1564);
         friendList.refreshText(param1,"motto_text",var_738,var_2157);
         friendList.refreshButton(param1,"offline",!var_738,null,0);
         if(var_738)
         {
            refreshFigure(param1,var_2158);
