package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         var_387.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_387.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      public function getCountOfOpenRequests() : int
      {
         ...
         {
            if(_loc2_.state == FriendRequest.const_133)
            {
               _loc1_++;
            }
         }
      ...
      {
         var_215.push(param1);
         var_387.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         for each(_loc3_ in var_215)
         {
            if(!param1 || _loc3_.state != FriendRequest.const_133)
            {
               _loc2_.push(_loc3_);
            }
         }
         ...
         {
            Util.remove(var_215,_loc4_);
            if(false)
            {
               var_387.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
