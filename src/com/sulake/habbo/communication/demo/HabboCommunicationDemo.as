package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2248:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1593:ILogger;
      
      private var var_1366:String;
      
      private var var_2246:String;
      
      private const const_1440:String = "fuselogin";
      
      private var var_315:ICoreCommunicationManager;
      
      private var var_443:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_1091)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_175);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1389:
            case DisconnectReasonEvent.const_1183:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1352:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2247)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_754 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_754);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1366,var_2246));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1440,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_443.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_443.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2248);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1440,"/");
      ...
      {
         var_754 = _habboConfiguration.getKey("sso.ticket",null);
         var_1366 = _habboConfiguration.getKey("flash.client.url","");
         var_2246 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_178 == null)
         {
         ...
         if(var_754 != null)
         {
            var_64.mode = HabboConnectionType.const_419;
            var_64.initConnection(HabboConnectionType.const_277);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1593 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_533);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2248 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_64.mode)
         {
            case HabboConnectionType.const_419:
               _loc6_ = "";
               ...
               var_1090 = _loc4_;
               var_178.loadBannerImage(_loc7_ + "?token=" + var_1090,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_911:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1189:
               var_623 = generateRandomHexString(30);
               var_443 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_443.init(var_623);
               _loc8_ = var_443.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1090);
         ...
         var_443 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_443.init(_loc14_);
            _loc15_ = var_443.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_911;
            }
         }
         var_64.initConnection(HabboConnectionType.const_277);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_215);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_170,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_104,onRoomSessionEnded);
      }
