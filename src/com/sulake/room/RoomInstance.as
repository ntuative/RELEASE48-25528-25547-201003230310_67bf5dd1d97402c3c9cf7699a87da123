package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function setString(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_483[param1] != param2)
         {
            var_483[param1] = param2;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_483 != null)
         {
            for(_loc1_ in var_483)
            {
               delete var_483[_loc1_];
            }
            var_483 = null;
         }
         var_1021 = [];
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(var_127)
               {
                  var_127.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_127)
                  {
                     var_127.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
