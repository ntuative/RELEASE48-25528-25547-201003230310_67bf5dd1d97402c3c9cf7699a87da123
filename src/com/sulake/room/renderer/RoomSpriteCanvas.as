package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_797:int = 50;
      ...
      private var var_241:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_2251:Number = -10000000;
      
      private var var_2249:Number = -10000000;
      
      private var var_2347:int = 0;
      
      private var var_532:RoomObjectCache;
      
      private var var_757:int;
      
      private var var_285:Sprite;
      
      private var var_1094:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_241 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
      ...
      public function update() : void
      {
         if(var_1092 == 0)
         {
            checkMouseHits(var_1093.x,var_1093.y,MouseEvent.MOUSE_MOVE);
         }
         var_1092 = 0;
         ++var_1594;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_285 != null)
         {
            var_285.graphics.clear();
         }
         else
         {
            var_285 = new Sprite();
            var_285.name = "mask";
            _master.addChild(var_285);
         }
         var_285.graphics.beginFill(0);
         var_285.graphics.drawRect(0,0,param1,param2);
         var_757 = param1;
         var_755 = param2;
         var_53.graphics.clear();
         var_53.graphics.beginFill(var_2347);
      ...
      {
         var _loc11_:Number = param1 - var_757 / 2;
         var _loc12_:Number = param2 - var_755 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_757 != var_2250 || var_755 != var_2252)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_444.sortOn("z",0 | 0);
         if(_loc6_ < var_444.length)
         {
            var_444.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_444[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_756.push(_loc12_ - _loc2_);
         if(var_756.length == const_797)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_797)
            {
               _loc13_ += var_756[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_531.length)
            {
               cleanSprite(var_531[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_531 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_320 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < var_320.length)
         {
            _loc2_ = var_320.getKey(_loc1_);
            _loc3_ = var_320.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1094 != null)
                  {
                     var_1094.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1594,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_241.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_241.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_444.length)
         {
            return null;
         }
         return var_444[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_530.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_530.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2251 || param2 != var_2249)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_530.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_530.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_531.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_241.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_241.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_241.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_241.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_532.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_532.getObjectCache(param2);
         ...
         _loc12_ += int(var_757 / 2);
         _loc13_ += int(var_755 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_757 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_755))
                  {
