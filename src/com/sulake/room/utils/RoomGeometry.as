package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_507:Number = 64;
      
      public static const const_981:Number = 32;
      ...
      private var var_2338:Number = 500;
      
      private var var_1430:Number = 1;
      
      private var var_81:Vector3d;
      
      private var var_82:Vector3d;
      
      private var var_2337:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_82 = new Vector3d();
         var_979 = new Vector3d();
         var_1432 = 1;
         var_1430 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1431 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_212.assign(param1);
         if(var_212.x != _loc2_ || var_212.y != _loc3_ || var_212.z != _loc4_)
         {
            ++var_73;
         }
      ...
      {
         if(var_385 != param1 * var_1431)
         {
            var_385 = param1 * var_1431;
            ++var_73;
         }
      }
      ...
      {
         if(var_382 != param1 * var_1432)
         {
            var_382 = param1 * var_1432;
            ++var_73;
         }
      }
      ...
      {
         if(var_384 != param1 * var_1430)
         {
            var_384 = param1 * var_1430;
            ++var_73;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_383 != null)
         {
            ...
            var_383.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_383.add(_loc3_,_loc4_);
            ++var_73;
         }
      }
      ...
      {
         return new Vector3d(var_212.x,var_212.y,var_212.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_979.assign(_loc22_);
         }
         else
         {
            var_979.assign(_loc17_);
         }
         ++var_73;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,var_69);
         _loc2_.x *= var_382;
         _loc2_.y *= var_384;
         _loc2_.z *= var_385;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_979);
         if(_loc3_ < var_2337 || _loc3_ > var_2338)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,var_69);
            _loc2_.add(_loc6_);
            _loc2_.x *= var_382;
            _loc2_.y *= var_384;
            _loc2_.z *= var_385;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_979);
         }
      ...
      {
         return new Vector3d(0 * var_382,0 * var_384,0 * var_385);
      }
      ...
      {
         return scale == const_507;
      }
      
      public function get scale() : Number
      {
         return var_184 / Math.sqrt(0.5);
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var_69.y = 0 / var_384;
         var_69.z = 0 / var_385;
         if(var_69.x != _loc2_ || var_69.y != _loc3_ || var_69.z != _loc4_)
         {
            ++var_73;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_383 != null)
         {
            ...
            return var_383.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_184;
         var _loc6_:Number = -param1.y / var_184;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_81,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_382,0 * var_384,0 * var_385);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_82;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_382,param2.y * var_384,param2.z * var_385);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_382,param3.y * var_384,param3.z * var_385);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_382,param4.y * var_384,param4.z * var_385);
