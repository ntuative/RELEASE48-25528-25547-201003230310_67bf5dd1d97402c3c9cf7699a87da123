package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_798:XML = null;
      
      private var var_32:int = 0;
      
      private var var_106:IRoomManagerListener;
      ...
      private var var_471:IRoomObjectFactory = null;
      
      private var var_1578:int;
      
      private var var_2358:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_470 = [];
         var_469 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_320,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_366,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_670,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_32 == const_1261)
         {
            if(var_798 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_393.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_393.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_471.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_471 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_471 != null)
         {
            return var_471.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_106 != null)
            {
               var_106.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(var_106 != null)
            {
               var_106.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(var_106 != null)
         {
            var_106.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_42.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_470.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_470.splice(_loc2_,1);
            }
            if(false)
            {
               ...
               if(var_106 != null)
               {
                  var_106.roomManagerInitialized();
               }
            }
         }
         else
         {
            var_32 = const_536;
            var_106.roomManagerInitialized(false);
         }
      }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_393.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_393.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_471.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(var_106 != null)
                                 {
                                    var_106.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
